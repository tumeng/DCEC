                    ...
                    <dx:ContentControl runat="server">
                        <table>
                           <%-- <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxDateEdit ID="ASPxDateEdit1" runat="server" Width="160px" EditFormatString="yyyy-MM-dd HH:mm:ss" >
                                ...
                                <td>
                                    <dx:ASPxDateEdit ID="ASPxDateEdit3" runat="server" Width="160px" EditFormatString="yyyy-MM-dd HH:mm:ss" >
                                        <CalendarProperties ClearButtonText="清空" TodayButtonText="今天">
                                        </CalendarProperties>
                                    </dx:ASPxDateEdit>
                                </td>
                        ...
                        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="计算日志" FieldName="JITLOG" VisibleIndex="6" Width="380px"
                                    Settings-AutoFilterCondition="Contains">
                                    <Settings AutoFilterCondition="Contains"></Settings>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="计算时间" FieldName="JITTIME" VisibleIndex="3" Width="150px"
                                    Settings-AutoFilterCondition="Contains"  >
                                    <Settings AutoFilterCondition="Contains"></Settings>
                                </dx:GridViewDataTextColumn>
