...
//                alert("清零操作已取消！");
    ...
    <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" KeyFieldName="MATERIAL_CODE"
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="物料地点" FieldName="QADSITE" VisibleIndex="1" Width="100px"
            ...
            <dx:GridViewDataTextColumn Caption="物料名称" FieldName="PT_DESC2" VisibleIndex="3" Width="240px"
                Settings-AutoFilterCondition="Contains">
                <Settings AutoFilterCondition="Contains"></Settings>
            </dx:GridViewDataTextColumn>
            ...
            <dx:GridViewDataTextColumn Caption="生产线" FieldName="GZDD" VisibleIndex="5" Width="80px"
        ...
        <Templates>
            <EditForm>
                <table>
                    <tr>
                        <td style="height: 10px ; color:Blue " colspan="6" >
                            选择生产线和物料代码后会自动带出物料地点和物料名称
                        </td>
                    </tr>
                    <tr>
