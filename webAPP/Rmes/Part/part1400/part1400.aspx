        ...
        <tr>
            ...
            <td>
                <dx:ASPxComboBox ID="txtPCode" runat="server" DataSourceID="SqlCode" TextField="PLINE_NAME" 
                    ...
                    <ClientSideEvents SelectedIndexChanged="function(s,e){ PlanCode.PerformCallback(Pcode.GetValue());  }" />
                </dx:ASPxComboBox>
            </td>
            <td>
            ...
            <td>
                <dx:ASPxComboBox ID="ComboPlanCode" runat="server" DataSourceID="sqlPlanCode" TextField="PLAN_CODE"
                    ...
                    ClientInstanceName="PlanCode" oncallback="ComboPlanCode_Callback">
                </dx:ASPxComboBox>
            </td>
            <td>
            </td>
    ...
    <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" KeyFieldName="PLAN_CODE"
        ...
        <Templates>
            ...
            initEditSeries(s,e);
                        ...
                        <td style="width: 200px">
                            <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="计划号"  width="120px">
                            </dx:ASPxLabel>
                        </td>
                        <td style="width: 90px">
                    ...
                    <tr>
                        ...
                        <td style="width: 200px;">
                            <dx:ASPxLabel ID="ASPxLabel8" runat="server" Text="数量"  width="120px">
                            </dx:ASPxLabel>
                        </td>
                        <td style="width: 170px;">
                        ...
                        <td style="width: 200px;">
                            <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="SO："  width="120px">
                            </dx:ASPxLabel>
                        </td>
                        <td style="width: 170px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxLabel ID="ASPxLabel7" runat="server" Text="上线时间:"  width="120px">
                            </dx:ASPxLabel>
                        </td>
                        <td>
                        ...
                        <td style="width: 200px">
                            <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="上线工位"  width="120px">
                            </dx:ASPxLabel>
                        </td>
                        <td style="width: 90px">
