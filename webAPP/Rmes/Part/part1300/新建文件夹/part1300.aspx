...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table>
        ...
        <tr>
            ...
            <dx:ASPxListBox ID="ASPxListBoxLocation" runat="server" DataSourceID="SqlLocation"
                Width="150px" Height="180px" ValueField="LOCATION_CODE" ValueType="System.String">
                <Columns>
    ...
    <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False"
        Width="100%" KeyFieldName="LOCATION_CODE" OnRowInserting="ASPxGridView1_RowInserting"
            ...
            <EditForm>
                <table>
                    ...
                    <tr>
                        ...
                        <td style="width: 170px">
                            <dx:ASPxComboBox ID="txtPCode" runat="server" DropDownStyle="DropDownList" ValidationSettings-ValidationGroup="<%# Container.ValidationGroup %>"
                                Value='<%# Bind("GZDD") %>' Width="120px" SelectedIndex="0">
                    ...
                    <tr>
                        ...
                        <td style="width: 140px;">
                            <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="工位工时（分钟）" Width="140px">
                            </dx:ASPxLabel>
                        </td>
                        <td style="width: 170px;">
