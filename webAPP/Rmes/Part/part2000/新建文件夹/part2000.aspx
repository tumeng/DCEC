...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <td>
                <dx:ASPxGridLookup ID="ComboBillCode" runat="server" DataSourceID="sqlBillCode"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataColumn FieldName="BILL_CODE" Caption="单据号" Width="100px"/>
                    </Columns>
                </dx:ASPxGridLookup>
            </td>
            <td>
    ...
    <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid"
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="工位" FieldName="LOCATION_CODE" VisibleIndex="3" Width="100px" 
                CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="零件号" FieldName="MATERIAL_CODE" VisibleIndex="4" Width="100px" 
                CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="零件名称" FieldName="MATERIAL_NAME" VisibleIndex="5" Width="100px" 
                CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="数量" FieldName="MATERIAL_NUM" VisibleIndex="6" Width="100px" 
                CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            ...
            <dx:GridViewDataTextColumn Caption="计划员" FieldName="PART_CHARGER" VisibleIndex="10" Width="100px" 
                CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
        </Columns>
    </dx:ASPxGridView>
