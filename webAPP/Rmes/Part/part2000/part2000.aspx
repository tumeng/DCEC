...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        ...
        <tr>
            ...
            <td>
                <dx:ASPxComboBox ID="ComboGzdd" runat="server" DataSourceID="sqlGzdd" ValueField="PLINE_CODE"
                    TextField="PLINE_NAME" ValueType="System.String" Width="120px" SelectedIndex="0"
                    ClientInstanceName="PCode">
                    <ClientSideEvents SelectedIndexChanged="function (s,e) {BillPanel.PerformCallback(PCode.GetValue());}" />
                </dx:ASPxComboBox>
            </td>
            <td>
            ...
            <td>
                <dx:ASPxCallbackPanel runat="server" ID="ASPxCallbackPanel4" ClientInstanceName="BillPanel"
                    OnCallback="ASPxCallbackPanel4_Callback">
                    <PanelCollection>
                        <dx:PanelContent ID="PanelContent4" runat="server">
                            <dx:ASPxGridLookup ID="ComboBillCode" runat="server" DataSourceID="sqlBillCode" Width="170px"
                                AutoGenerateColumns="False" ClientInstanceName="gridLookup" KeyFieldName="BILL_CODE"
                                TextFormatString="{0}" SelectionMode="Single">
                                <GridViewProperties>
    ...
    <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" KeyFieldName="ROWID">
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="单据号" FieldName="BILL_CODE" VisibleIndex="1" Width="120px"
                Settings-AutoFilterCondition="Contains" CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="计划号" FieldName="PLAN_CODE" VisibleIndex="2" Width="100px"
                Settings-AutoFilterCondition="Contains" CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="工位" FieldName="LOCATION_CODE" VisibleIndex="3"
                Width="100px" Settings-AutoFilterCondition="Contains" CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="零件号" FieldName="MATERIAL_CODE" VisibleIndex="4"
                Width="100px" Settings-AutoFilterCondition="Contains" CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="零件名称" FieldName="MATERIAL_NAME" VisibleIndex="5"
                Width="100px" Settings-AutoFilterCondition="Contains" CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="数量" FieldName="MATERIAL_NUM" VisibleIndex="6"
                Width="100px" Settings-AutoFilterCondition="Contains" CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="供应商" FieldName="GYS_CODE" VisibleIndex="7" Width="100px"
                Settings-AutoFilterCondition="Contains" CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="保管员" FieldName="BGY_CODE" VisibleIndex="8" Width="100px"
                Settings-AutoFilterCondition="Contains" CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="日程单" FieldName="PO_NBR" VisibleIndex="9" Width="100px"
                Settings-AutoFilterCondition="Contains" CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="计划员" FieldName="PART_CHARGER" VisibleIndex="10"
                Width="100px" Settings-AutoFilterCondition="Contains" CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
        </Columns>
    </dx:ASPxGridView>
