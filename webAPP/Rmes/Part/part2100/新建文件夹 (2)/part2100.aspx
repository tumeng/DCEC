...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <dx:ASPxComboBox ID="ComboTable" runat="server" DropDownStyle="DropDownList" SelectedIndex="0" Width="160px">
                    <Items>
        ...
        <tr>
            ...
            <td>
                <dx:ASPxComboBox ID="ComboBillCode" runat="server" DataSourceID="sqlBillCode" TextField="BILL_CODE" Width="160px" ClientInstanceName="billCode"
                    OnCallback="ComboBillCode_Callback">
                </dx:ASPxComboBox>
            </td>
            <%--<td>
        ...
        <tr>
            ...
            <td>
                <dx:ASPxTextBox ID="TextMaterialCode" runat="server" Width="160px"></dx:ASPxTextBox>
            </td>
            <td>
            ...
            <td>
                <dx:ASPxButton ID="queryGrid" runat="server" Text="查询" AutoPostBack="false">
    ...
    <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="数量" FieldName="SUM_MATERIAL_NUM" VisibleIndex="5" Width="100px" Settings-AutoFilterCondition="Contains" 
                CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="工位" FieldName="LOCATION_CODE" VisibleIndex="6" Width="100px" Settings-AutoFilterCondition="Contains" 
                CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            ...
            <dx:GridViewDataTextColumn Caption="库房" FieldName="INV_CODE" VisibleIndex="9" Width="100px" Settings-AutoFilterCondition="Contains" 
                CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            ...
            <dx:GridViewDataTextColumn Caption="大致使用时间" FieldName="REQUIRE_TIME" VisibleIndex="11" Width="100px" Settings-AutoFilterCondition="Contains" 
                CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
