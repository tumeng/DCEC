...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        function initEditSeries(s, e) {
            ...
            if (str1 != "") {
                ...
                if (PCode.GetValue() == 'L') {
                    IGzdd.SetValue(PCode.GetValue());
                    for (var i = items.length - 1; i >= 0; i = i - 1) {
                        if (i == 0) RGzdd.SetValue(items[i]);
                        RGzdd.AddItem(items[i], items[i]);
                    }
                }
                else if (PCode.GetValue() != 'R') {
                    RGzdd.SetValue(PCode.GetValue());
                    IGzdd.SetValue(PCode.GetValue());
                }
                else {
                    RGzdd.SetValue(PCode.GetValue());
                    for (var i = items.length - 1; i >= 0; i = i - 1) {
                        if (i == 0) IGzdd.SetValue(items[i]);
                        IGzdd.AddItem(items[i], items[i]);
                    }
                }
        ...
        <tr>
            ...
            <td>
                <dx:ASPxComboBox ID="txtPCode" runat="server" DataSourceID="SqlCode" TextField="PLINE_NAME"
                    ClientInstanceName="PCode" ValueField="PLINE_CODE" ValueType="System.String"
                    Width="120px" DropDownStyle="DropDownList" SelectedIndex="0">
                    <ClientSideEvents SelectedIndexChanged="function(s,e){
                           RLoction.PerformCallback(PCode.GetValue());
                        }" />
                </dx:ASPxComboBox>
            </td>
            <td>
            ...
            <td>
                <dx:ASPxComboBox ID="CombRLocation" runat="server" DataSourceID="SqlRLocation" TextField="LOCATION_CODE"
                    ValueField="LOCATION_CODE" ValueType="System.String" Width="120px" ClientInstanceName="RLoction"
                    OnCallback="txtRLoction_Callback" SelectedIndex="0">
                </dx:ASPxComboBox>
            </td>
            <td>
            </td>
    ...
    <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="发料工位" FieldName="ISSUE_LOCATION" VisibleIndex="4"
                Width="120px" Settings-AutoFilterCondition="Contains">
                <Settings AutoFilterCondition="Contains"></Settings>
            </dx:GridViewDataTextColumn>
                ...
                <table>
                    ...
                    initEditSeries(s,e);
                        ...
                        <td style="width: 200px">
                            <dx:ASPxComboBox ID="txtRLocation" runat="server"   Value='<%# Bind("REAL_LOCATION") %>'
                                ValidationSettings-ValidationGroup="<%# Container.ValidationGroup %>" Width="200px"
                                ClientInstanceName="RLocation">
                                <ValidationSettings ErrorDisplayMode="ImageWithTooltip" ErrorText="输入有误，请重新输入！" SetFocusOnError="True"
                                    ValidateOnLeave="True">
                                    <RegularExpression ErrorText="长度不能超过15！" ValidationExpression="^.{0,15}$" />
                                    <RequiredField ErrorText="不能为空！" IsRequired="True" />
                    ...
                    initEditSeries(s,e);
                        ...
                        <td style="width: 120px">
                            <dx:ASPxComboBox ID="txtRGzdd" runat="server"   ValidationSettings-ValidationGroup="<%# Container.ValidationGroup %>"
                    ...
                    <tr>
                        ...
                        <td style="width: 120px;">
                            <dx:ASPxComboBox ID="txtIGzdd" runat="server" Value='<%# Bind("ISSUE_GZDD") %>' ValidationSettings-ValidationGroup="<%# Container.ValidationGroup %>"
                                Width="120px" ClientInstanceName="IGzdd">
                                <ValidationSettings ErrorDisplayMode="ImageWithTooltip" ErrorText="输入有误，请重新输入！" SetFocusOnError="True"
                                    ValidateOnLeave="True">
