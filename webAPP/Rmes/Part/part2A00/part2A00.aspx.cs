 ...
 * 创建时间：2016-08-03
 */
namespace Rmes.WebApp.Rmes.Part.part2A00
{
    public partial class part2A00 : BasePage
    {
        ...
        private void initPlanCode()
        {
            ...
            //string a="select distinct plan_code from ms_single_plan_inner where gzdd='" + gSite + "' order by plan_code";
            string sql = "select distinct plan_code from ms_single_plan_inner where gzdd in (select pline_code from vw_user_role_program where user_id='" + theUserId + "' and program_code='" + theProgramCode + "' and company_code='" + theCompanyCode + "') order by plan_code";
        ...
        {
            string sql = "";
            sql = "select * from ms_single_plan_inner WHERE GZDD IN(select pline_code from vw_user_role_program where user_id='" + theUserId + "' and program_code='" + theProgramCode + "' and company_code='" + theCompanyCode + "')  "
                + "AND ONLINE_TIME>=to_date('" + StartDateQ.Text.Trim() + "','YYYY-MM-DD  hh24:mi:ss') AND ONLINE_TIME<=to_date('" + EndDateQ.Text.Trim() + "','YYYY-MM-DD  hh24:mi:ss')";
        ...
        protected void ASPxGridView1_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            ...
            string Sql = "INSERT INTO ms_single_plan_inner(PLAN_CODE,PLAN_SO,PLAN_NUM,ONLINE_LOCATION,ONLINE_TIME,FLAG,ADD_TIME,GZDD)"
        ...
        protected void ASPxGridView1_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            ...
            string strTableName = "ms_single_plan_inner";
            ...
            {
                //确认删除
                string Sql = "delete from ms_single_plan_inner WHERE  plan_code='" + strPlanCode + "' and flag='N' and gzdd='" + strPCode + "'";
                dc.ExeSql(Sql);
            }
            setCondition();
            e.Cancel = true;
        ...
        protected void ASPxGridView1_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            ...
            string strOnLocation = uOnLocation.Value.ToString();
            string strOnlinetime = uOnlinetime.Text.Trim();
            string Sql = "update ms_single_plan_inner set PLAN_NUM='" + strPNum + "',online_location='" + strOnLocation + "',online_time=to_date('" + uOnlinetime.Value + "','yyyy-mm-dd hh24:mi:ss')"
        ...
        {
            ASPxDateEdit onlieTime = ASPxGridView1.FindEditFormTemplateControl("DateOnlinetime") as ASPxDateEdit;
            onlieTime.Text = DateTime.Now.ToLongTimeString();
            ...
            string Sql2 = "select distinct plan_code from DATA_PLAN where pline_code in(select pline_code from vw_user_role_program where user_id='" + theUserId + "' and program_code='" + theProgramCode + "' and company_code='" + theCompanyCode + "') and ITEM_FLAG='1' and "
        ...
        protected void ASPxGridView1_RowValidating(object sender, DevExpress.Web.Data.ASPxDataValidationEventArgs e)
        {
            ...
            if (ASPxGridView1.IsNewRowEditing && !ASPxGridView1.IsEditing)
            {
                string chSql = "select * from ms_single_plan_inner where plan_code='" + strPlanCode + "' and flag='N' and gzdd='" + strPCode + "'";
