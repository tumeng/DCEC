<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="part2A00.aspx.cs" Inherits="Rmes.WebApp.Rmes.Part.part2A00.part2A00" %>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="width: 100px">
                            <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="生产线" width="100px">
                            </dx:ASPxLabel>
                        </td>
                        ...
                        <td style="width: 100px">
                            <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="计划号"  width="100px">
                            </dx:ASPxLabel>
                        </td>
                        <td style="width: 90px">
                    ...
                    <tr>
                        ...
                        <td style="width: 100px;">
                            <dx:ASPxLabel ID="ASPxLabel8" runat="server" Text="数量"  width="100px">
                            </dx:ASPxLabel>
                        </td>
                        <td style="width: 170px;">
                        ...
                        <td style="width: 100px;">
                            <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="SO："  width="100px">
                            </dx:ASPxLabel>
                        </td>
                        <td style="width: 170px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxLabel ID="ASPxLabel7" runat="server" Text="上线时间:"  width="100px">
                            </dx:ASPxLabel>
                        </td>
                        <td>
                        ...
                        <td style="width: 100px">
                            <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="上线工位"  width="100px">
                            </dx:ASPxLabel>
                        </td>
                        <td style="width: 90px">
