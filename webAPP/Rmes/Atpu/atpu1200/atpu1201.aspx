<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="atpu1201.aspx.cs" Inherits="Rmes_atpu1201" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <dx:ASPxPageControl runat="server" ID="pageControl" Width="100%" EnableCallBacks="True"
        ActiveTabIndex="0">
        <TabPages>
            <dx:TabPage Text="流水号号段维护" Visible="false">
                <ContentCollection>
                    <dx:ContentControl ID="ContentControl1" runat="server">
                        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="初始值" FieldName="INITIAL_VALUE" VisibleIndex="2"
                                ...
                                <EditForm>
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 80px">
                                                <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="初始值">
                                                </dx:ASPxLabel>
                                            </td>
                                            <td style="width: 170px">
                            ...
                            <ClientSideEvents BeginCallback="function(s, e) {grid.cpCallbackName = '';}" EndCallback="function(s, e) 
        {
            ...
            <dx:TabPage Text="预留号维护" Visible="true">
                <ContentCollection>
