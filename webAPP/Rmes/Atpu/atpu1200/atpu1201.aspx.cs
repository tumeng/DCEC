...
public partial class Rmes_atpu1201 : Rmes.Web.Base.BasePage
{
    ...
    private void setCondition()
    {
        ...
        string sql = "SELECT T.RMES_ID,T.COMPANY_CODE,T.PLINE_CODE,B.PLINE_NAME,T.INITIAL_VALUE,T.CURRENT_VALUE,T.MAX_VALUE,T.INCREASE_FLAG,A.INTERNAL_NAME, "
            ...
            + "and T.PLINE_CODE IN (SELECT PLINE_CODE FROM VW_USER_ROLE_PROGRAM WHERE USER_ID='" + theUserId + "' and program_code='" + theProgramCode + "' and company_code='" + theCompanyCode + "')  ORDER BY T.MAX_VALUE";
        ...
        string sql2 = "SELECT A.RMES_ID,A.COMPANY_CODE,A.PLINE_CODE,B.PLINE_NAME,A.SN,C.INTERNAL_NAME,A.SN_FLAG FROM CODE_SN_RESERVE A LEFT JOIN CODE_PRODUCT_LINE B "
            ...
            + " and A.PLINE_CODE IN (SELECT PLINE_CODE FROM VW_USER_ROLE_PROGRAM WHERE USER_ID='" + theUserId + "' and program_code='" + theProgramCode + "' and company_code='" + theCompanyCode + "') order by  A.SN  ";
