...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <ContentCollection>
                    <dx:ContentControl runat="server">
                        ...
                        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False"
                            Width="100%" KeyFieldName="GZDD;ZDMC;LJDM" OnRowInserting="ASPxGridView1_RowInserting"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="零件种类" FieldName="PART_ABC_NAME" VisibleIndex="7"
                                    Settings-AutoFilterCondition="Contains" Width="150px">
                                    <Settings AutoFilterCondition="Contains"></Settings>
                                </dx:GridViewDataTextColumn>
                                ...
                                <EditForm>
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 170px">
                                                <dx:ASPxComboBox ID="comboLJLB" runat="server" ClientInstanceName="comboLJLB_C" EnableClientSideAPI="True"
                                                    Value='<%# Bind("PART_ABC") %>' DropDownStyle="DropDownList" DataSourceID="SqlLJLB"
                                                    ValueType="System.String" Width="150px" TextField="INTERNAL_NAME" ValueField="INTERNAL_CODE"
                                                    ValidationSettings-ValidationGroup="<%# Container.ValidationGroup %>">
                                                    <ValidationSettings SetFocusOnError="True" ValidateOnLeave="True" ErrorText="输入有误，请重新输入！"
                                                        ErrorDisplayMode="ImageWithTooltip">
                                        ...
                                        <tr>
                                            <td style="height: 10px" colspan="7">
                                                <label id="id1" runat="server" style="color: Red">
                                                    单件码为A类，批次码为B类，单批次码为D类，其他零件为C类</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="height: 10px" colspan="7">
    ...
    <asp:SqlDataSource ID="SqlDataSource22" runat="server" ConnectionString="<%$ ConnectionStrings:oracle %>"
        ProviderName="<%$ ConnectionStrings:oracle.ProviderName %>"></asp:SqlDataSource>
         <asp:SqlDataSource ID="SqlDataSource_Station" runat="server" ConnectionString="<%$ ConnectionStrings:oracle %>"
        ProviderName="<%$ ConnectionStrings:oracle.ProviderName %>"></asp:SqlDataSource>
</asp:Content>
