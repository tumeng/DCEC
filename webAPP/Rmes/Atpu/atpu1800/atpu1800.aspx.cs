...
public partial class Rmes_atpu1800 : Rmes.Web.Base.BasePage
{
    ...
    protected void ASPxGridView1_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
    {
        ...
        ASPxTextBox txtSO = ASPxGridView1.FindEditFormTemplateControl("txtSO") as ASPxTextBox;
    ...
    protected void ASPxGridView1_RowValidating(object sender, DevExpress.Web.Data.ASPxDataValidationEventArgs e)
    {
        ...
        {
            string chSql = "select distinct PLAN_SO as showtext from DATA_PLAN WHERE PLAN_SO='" + strSO + "'";
            ...
            {
                string chSql2 = "SELECT SO FROM JWTCMSO WHERE SO='" + strSO + "'";
