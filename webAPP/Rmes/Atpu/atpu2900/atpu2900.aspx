    ...
    <div>
        <script type="text/javascript">
            function initEditSeries(s, e) {
                if (SO.GetValue() == null && FR.GetValue() == null) {
                    return;
                }
                var webFileUrl = "?SO=" + SO.GetValue() + "&FR=" + FR.GetValue() + " &opFlag=getEditSeries";
                var result = "";
...
//                FR.SetValue(array1[33]);
        ...
        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False"
            ...
            OnHtmlEditFormCreated="ASPxGridView1_HtmlEditFormCreated" Settings-ShowHorizontalScrollBar="true">
            <Columns>
                    ...
                    <table>
                        <tr>
                            <td style="height: 34px">
                                <span style="color: Blue; font-size: 10pt">输入一个SO或者FR号，按“回车”键，可带入该SO的相关参数信息</span>
                            </td>
