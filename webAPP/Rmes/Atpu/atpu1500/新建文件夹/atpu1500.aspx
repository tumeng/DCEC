...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False"
        ...
        OnRowUpdating="ASPxGridView1_RowUpdating" OnRowValidating="ASPxGridView1_RowValidating"  OnCustomCallback="ASPxGridView1_CustomCallback"
        OnHtmlEditFormCreated="ASPxGridView1_HtmlEditFormCreated" OnCustomButtonCallback="ASPxGridView1_CustomButtonCallback">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="width: 90px; text-align: left;">
                            <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="站点代码">
                            </dx:ASPxLabel>
                        </td>
                        <td style="width: 180px">
                            <dx:ASPxGridLookup ID="GridLookupCode" runat="server" Text='<%# Bind("LOCATION_CODE") %>'
                                ClientInstanceName="GridLookupCode" DataSourceID="SqlCode" KeyFieldName="LOCATION_CODE"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataColumn FieldName="LOCATION_CODE" Visible="false" />
                                    <dx:GridViewDataColumn Caption="站点代码" FieldName="LOCATION_CODE" />
