    ...
    <script type="text/javascript">
        function checkData() {
            ...
            if (CheckSn.GetChecked())
                if (dateFrom.substring(5) != dateTo.substring(5)) {
    ...
    <table style="width:100%;">
        ...
        <tr>
            ...
            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" 
                ...
                <Columns>
                    <dx:GridViewDataTextColumn Caption="零件" FieldName="ABOM_COMP"   VisibleIndex="1" Width="30%"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="工位" FieldName="ABOM_WKCTR" VisibleIndex="2" Width="30%"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="库位" FieldName="ABOM_KW" VisibleIndex="3" Width="20%"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="数量" FieldName="ABOM_QTY" VisibleIndex="4" Width="20%" />        
                </Columns> 
