<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mmsMaterialRequisitionLQ.aspx.cs" Inherits="Rmes.WebApp.Rmes.MmsDcec.mmsMaterialRequisition.mmsMaterialRequisitionLQ" StylesheetTheme="Theme1" %>
...
<body>
    ...
    <table>
        <tr>
            ...
            <td>
                <dx:ASPxComboBox runat="server" ID="cmbPline" ClientInstanceName="cmbPline" Width="120px" oninit="cmbPlineCode_Init">
                </dx:ASPxComboBox>
            </td>
            <td align="right">
        ...
        <tr>
            ...
            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="发料工位" FieldName="FLGW1" VisibleIndex="5" Width="100px" />
                    ...
                    <dx:GridViewDataTextColumn Caption="站点发料" FieldName="FLGW" VisibleIndex="19"  Width="80px"></dx:GridViewDataTextColumn>
