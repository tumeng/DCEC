<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mmsReplaceRelationshipQry.aspx.cs" Inherits="Rmes.WebApp.Rmes.MmsDcec.mmsReplaceRelationshipQry.mmsReplaceRelationshipQry" StylesheetTheme="Theme1" %>
...
<body>
    ...
    <dx:ASPxGridView ID="ASPxGridView1" runat="server" Width="100%" KeyFieldName="SO" SettingsPager-Mode="ShowAllRecords" >
                <TotalSummary>
                    <dx:ASPxSummaryItem FieldName="SO" SummaryType="Count" DisplayFormat="总数={0}" />
                </TotalSummary>
