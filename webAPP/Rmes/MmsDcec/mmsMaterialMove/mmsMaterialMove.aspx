<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mmsMaterialMove.aspx.cs" Inherits="Rmes.WebApp.Rmes.MmsDcec.mmsMaterialMove.mmsMaterialMove" StylesheetTheme="Theme1" %>
...
<%--            <td>
                <dx:ASPxHyperLink ID="ASPxHyperLink1" runat="server" Text="ASPxHyperLink" NavigateUrl="\\192.168.112.144\TRANLIST\TL161101B-140951.txt" />
            </td>--%>
        </tr>
    </table>
    <table style="width:100%;">
        ...
        <Settings ShowFooter="True" />
                ...
                if(callbackValue!='.txt')
                    window.open('http://192.168.112.144/tranlist/'+callbackValue);
