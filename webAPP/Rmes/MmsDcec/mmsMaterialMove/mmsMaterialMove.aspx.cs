    ...
    public partial class mmsMaterialMove : System.Web.UI.Page
    {
        ...
        protected void ASPxGridView1_CustomCallback(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                FileStream fs1 = new FileStream("C:\\TRANLIST\\" + theWriteFile + ".txt", FileMode.Create, FileAccess.ReadWrite,FileShare.ReadWrite);//创建写入文件 
            ...
            try
            {
                ////myWebClient.DownloadFileAsync(new Uri(@"\\192.168.112.144\TRANLIST\" + theWriteFile + ".txt"), @"C:\TRANLIST\" + theWriteFile + ".txt");
                ...
                //ASPxHyperLink1.NavigateUrl = @"\\192.168.112.144\TRANLIST\TL161101B-140951.txt";
            }
            catch { }
