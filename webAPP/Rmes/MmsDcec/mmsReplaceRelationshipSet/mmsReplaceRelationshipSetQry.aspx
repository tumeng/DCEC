<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mmsReplaceRelationshipSetQry.aspx.cs" Inherits="Rmes.WebApp.Rmes.MmsDCEC.mmsReplaceRelationshipSet.mmsReplaceRelationshipSetQry" StylesheetTheme="Theme1" %>
        ...
        <tr>
            <td>
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" KeyFieldName="SO" 
                    Width="100%">
                    <Columns>
                        <dx:GridViewDataTextColumn Caption="CONFIG或SO" FieldName="SO" VisibleIndex="1" Width="120px"></dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="开始时间" FieldName="USETIME" VisibleIndex="7" Width="140px"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="结束时间" FieldName="ENDTIME" VisibleIndex="8" Width="140px"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="分组" FieldName="THGROUP" VisibleIndex="9" Width="140px"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="维护时间" FieldName="CREATETIME" VisibleIndex="10" Width="140px"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="系列" FieldName="XL" VisibleIndex="11" Width="120px"></dx:GridViewDataTextColumn>
