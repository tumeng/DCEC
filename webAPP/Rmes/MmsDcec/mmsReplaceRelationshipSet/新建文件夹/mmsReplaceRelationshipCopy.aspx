<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mmsReplaceRelationshipCopy.aspx.cs" Inherits="Rmes.WebApp.Rmes.MmsDcec.mmsReplaceRelationshipSet.mmsReplaceRelationshipCopy" StylesheetTheme="Theme1" %>
    ...
    <table style="width:480px;">
        <tr>
            ...
            <td style="width:200px">
                <dx:ASPxComboBox ID="cmbPline" ClientInstanceName="cmbPline" runat="server" Width="100%" oninit="cmbPline_Init">
            ...
            <td style="width:100px">
                <dx:ASPxButton ID="cmdOne" runat="server" Width="100%" AutoPostBack="false" Text="一对一替换" >
                    <ClientSideEvents Click="function(s,e){
                        ...
                        if(cmbFromSo.GetText()=='') {alert('请先选择SO/机型!');return;}
                        ListToSo.ClearItems();
        ...
        <tr>
            <td colspan="2" valign="top"  style="width:60%">
                <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" Width="100%" 
                    AutoGenerateColumns="False" KeyFieldName="SO" 
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="CONFIG或SO" FieldName="SO" VisibleIndex="1" Width="100px"></dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="PE代用文件" FieldName="PEFILE"  VisibleIndex="5" Width="120px"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="用户" FieldName="CREATEUSER" VisibleIndex="6" Width="80px"></dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="分组" FieldName="THGROUP" VisibleIndex="9" Width="120px"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="维护时间" FieldName="CREATETIME" VisibleIndex="10" Width="120px"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="系列" FieldName="XL" VisibleIndex="11" Width="60px"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="SITE" Visible="false"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="SETTYPE" Visible="false"></dx:GridViewDataTextColumn>
                    </Columns>
            ...
            <td valign="top" colspan="3"  style="width:40%">
                <dx:ASPxListBox ID="ListToSo" ClientInstanceName="ListToSo" runat="server" Height="400px" Width="100%">
                </dx:ASPxListBox>
            </td>
        </tr>
        <tr>
