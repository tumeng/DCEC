...
<body>
    ...
    <script type="text/javascript">
        ...
        function checkData(s, e) {
            ...
            //            var fieldNames = "SETTYPE" + "," + "OLDPART" + "," + "NEWPART" + "," + "PEFILE" + "," + "USETIME" + "," + "ENDTIME" + "," + "XL" + "," + "THGROUP";
            //            var fieldNames = "OLDPART";
        ...
        //            if (result == "") {
        //                alert('没有选择复制的相关内容！无法进行操作');
        //            }
        //            else {
        ////                pline = listPline.GetValue().toString();

        ////                ref = "COPY," + result;
        //                CallbackSubmit.PerformCallback(result);
        //            }
        //        }
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td colspan="2" valign="top" style="width: 90%">
                <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" Width="100%"
                    AutoGenerateColumns="False" KeyFieldName="OLDPART;NEWPART" OnCustomCallback="ASPxGridView1_CustomCallback">
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="开始时间" FieldName="USETIME" VisibleIndex="7" Width="135px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="结束时间" FieldName="ENDTIME" VisibleIndex="8" Width="135px">
                        </dx:GridViewDataTextColumn>
            ...
            <td valign="top" colspan="3" style="width: 10%">
