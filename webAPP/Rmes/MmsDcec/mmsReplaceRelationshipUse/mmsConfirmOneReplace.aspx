...
<body>
    ...
    <dx:ASPxGridView ID="grid" runat="server" Width="100%" KeyFieldName="ROWID" SettingsPager-Mode="ShowAllRecords"
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="计划号" FieldName="JHDM" VisibleIndex="0" Width="100px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="SO号" FieldName="SO" VisibleIndex="2" Width="80px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="零件号" FieldName="LJDM1" VisibleIndex="3" Width="80px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="替换零件号" FieldName="LJDM2" VisibleIndex="4" Width="100px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="工位名称" FieldName="GWMC" VisibleIndex="5" Width="100px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="录入员工" FieldName="YGMC" VisibleIndex="6" Width="100px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="录入时间" FieldName="LRSJ" VisibleIndex="7" Width="150px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="是否确认" FieldName="ISTRUE" VisibleIndex="8" Width="80px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="现场提示" FieldName="BZ" VisibleIndex="14" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="替换数量" FieldName="THSL" VisibleIndex="15" Width="80px"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="确认人" FieldName="QRYGMC" VisibleIndex="16" Width="80px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
        </Columns>
