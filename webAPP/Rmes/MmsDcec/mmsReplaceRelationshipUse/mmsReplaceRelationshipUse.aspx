...
<body onunload="closeWin()">
    ...
    <script type="text/javascript">
        ...
        function OnGetRowValues(values) {
            ...
            document.getElementById("txtSo").value = so;
            
            gridOneReplace.PerformCallback(str);
            gridMaterial.PerformCallback("init|" + str);
            gridMultiReplace.PerformCallback(str);
        }
        function resetMaterial(flag) {
            gridMaterial.PerformCallback(flag);
        }
        function openConfirmedOneReplaceQuery() {
            ...
            var planCode = document.getElementById("txtPlanCode").value;
            var plineCode = cmbPline.GetValue();
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td>
                            ...
                            <dx:ASPxGridView ID="ASPxGridView1"  ClientInstanceName="gridPlan" Width="100%" 
                                runat="server" oncustomcallback="ASPxGridView1_CustomCallback" 
                                KeyFieldName="PLAN_CODE" onhtmlrowprepared="ASPxGridView1_HtmlRowPrepared" 
                                onpageindexchanged="ASPxGridView1_PageIndexChanged">
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="计划编号" FieldName="PLAN_CODE" VisibleIndex="0" Width="20%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="计划SO" FieldName="PLAN_SO" VisibleIndex="1" Width="15%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="数量" FieldName="PLAN_QTY" VisibleIndex="2" Width="10%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="用户名称" FieldName="CUSTOMER_NAME" VisibleIndex="3" Width="40%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="上线数量" FieldName="ONLINE_QTY" VisibleIndex="4" Width="15%"></dx:GridViewDataTextColumn>                         
                                </Columns>
                                <Settings ShowGroupPanel="false" ShowFilterRow="false" ShowVerticalScrollBar="false" ShowHorizontalScrollBar="true"/>
                                <SettingsPager PageSize="10"></SettingsPager>
                                <ClientSideEvents RowClick="function(s,e){
                                    gridPlan.GetRowValues(e.visibleIndex, 'PLAN_CODE;PLAN_SO', OnGetRowValues);
                                }" />
                                            ...
                                            <dx:ContentControl ID="ContentControl1" runat="server" SupportsDisabledAttribute="True">
                                                <dx:ASPxGridView ID="gridOneReplace" ClientInstanceName="gridOneReplace" 
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="生效时间" FieldName="USETIME1" VisibleIndex="6" Width=""></dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="失效时间" FieldName="ENDTIME1" VisibleIndex="6" Width=""></dx:GridViewDataTextColumn>
                                                    </Columns>
                                    ...
                                    <dx:TabPage Text="多对多替换">
                                        <ContentCollection>
                                            <dx:ContentControl ID="ContentControl2" runat="server" SupportsDisabledAttribute="True">
                                                <dx:ASPxGridView ID="gridMulitiReplace" ClientInstanceName="gridMultiReplace"  Settings-VerticalScrollableHeight="50"
                                                    runat="server" KeyFieldName="OLDPART" Width="100%"  SettingsPager-Mode="ShowAllRecords"
                                                    OnCustomCallback="gridMulitiReplace_CustomCallback"  Settings-ShowVerticalScrollBar="True"
                                                    OnPageIndexChanged="gridMulitiReplace_PageIndexChanged"  OnHtmlRowPrepared="gridMulitiReplace_HtmlRowPrepared"
                                                    OnInit="gridMulitiReplace_Init" Settings-ShowHorizontalScrollBar="True" Settings-VerticalScrollBarStyle="Standard">
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn Caption="原零件" FieldName="OLDPART" VisibleIndex="0" Width=""></dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="零件名称" FieldName="OLDPART_NAME" VisibleIndex="2" Width=""></dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="替换件" FieldName="NEWPART" VisibleIndex="3" Width=""></dx:GridViewDataTextColumn>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="分组" FieldName="THGROUP" VisibleIndex="6" Width="130px"></dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="生效时间" FieldName="USETIME1" VisibleIndex="6" Width=""></dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="失效时间" FieldName="ENDTIME1" VisibleIndex="6" Width=""></dx:GridViewDataTextColumn>
                                                    </Columns>      
                                                    <Settings ShowGroupPanel="false" ShowVerticalScrollBar="false" />
                    ...
                    <tr><%--OnCustomDataCallback="ASPxGridView1_CustomDataCallback"--%>
                        <td>
                            <dx:ASPxGridView ID="gridMaterial" ClientInstanceName="gridMaterial" 
                                ...
                                oncustombuttoninitialize="gridMaterial_CustomButtonInitialize" 
                                oninit="gridMaterial_Init" oncustombuttoncallback="gridMaterial_CustomButtonCallback" 
                                >
<%--                                        <ClientSideEvents CustomButtonClick="function (s,e){
        changeSeq(s,e);
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="类型" FieldName="ITEM_TYPE" VisibleIndex="9" Visible="false" Width="60px"></dx:GridViewDataTextColumn>
                                ...
                                <ClientSideEvents BeginCallback="function(s,e){gridMaterial.cpCallbackName='';gridMaterial.cpAlertContent='';}"
                                EndCallback="function(s,e){
                                    callbackName=gridMaterial.cpCallbackName;
                                    alertContent=gridMaterial.cpAlertContent;

                                    if(callbackName=='OneReplace'&&alertContent!='')
                                        alert(alertContent);
                                    if(callbackName=='MultiReplace'){
                                        plineCode=gridMaterial.cpplineCode;
                                        planCode=gridMaterial.cpplanCode;
                                        so=gridMaterial.cpso;
                                        itemCode=gridMaterial.cpitemCode;
                                        newPart=gridMaterial.cpnewPart;
                                        locationCode=gridMaterial.cplocationCode;
                                        itemQty=gridMaterial.cpitemQty;
    ...
    <p>
        <input id="txtPlanCode"  runat="server" type="hidden" />
        <input id="txtSo"  runat="server" type="hidden" />
    </p>
</body>
</html>
