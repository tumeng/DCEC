    ...
    <table style="width:100%;">
        <tr>
            ...
            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server"  SettingsPager-Mode="ShowAllRecords"
                    Width="100%" oncustomcallback="ASPxGridView1_CustomCallback" KeyFieldName="ABOM_JHDM;ABOM_COMP;ABOM_DESC;ABOM_WKCTR;ABOM_QTY">
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption=" " FieldName="BGY_CODE" VisibleIndex="4" Width="80px" />   
                    <dx:GridViewDataTextColumn Caption=" " FieldName="ABOM_QTY" VisibleIndex="4" Width="80px" />    
