    ...
    <table style="width:100%;">
        <tr>
            ...
            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server"  SettingsPager-Mode="ShowAllRecords"
                ...
                <Columns>
                    <dx:GridViewDataTextColumn Caption="MES单号" FieldName="ABOM_JHDM"   VisibleIndex="1" Width="100px"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="零件代码" FieldName="ABOM_COMP" VisibleIndex="2" Width="100px"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="零件名称" FieldName="ABOM_DESC" VisibleIndex="3" Width="150px"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="工位" FieldName="ABOM_WKCTR" VisibleIndex="4" Width="100px" />      
                    <dx:GridViewDataTextColumn Caption="数量" FieldName="ABOM_QTY" VisibleIndex="4" Width="100px" />      
                    <dx:GridViewDataTextColumn Caption="是否随机件" FieldName="SJ_FLAG" VisibleIndex="4" Width="100px" />        
                </Columns> 
