...
{
    public partial class mmsMultisReplaceDelWhConfirm : System.Web.UI.Page
    {
        ...
        protected void cmbPline_Init(object sender, EventArgs e)
        {
            ...
            string sql = "select pline_code,pline_name from vw_user_role_program a "
                + "where user_id='" + userId + "' and program_code='mmsMultiReplaceDelWhConfirm' and company_code='" + companyCode + "'";
            dc.setTheSql(sql);
