<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mmsMultiReplaceWhConfirm.aspx.cs" Inherits="Rmes.WebApp.Rmes.MmsDcec.mmsWarehouseConfirm.mmsMultisReplaceWhConfirm" StylesheetTheme="Theme1" %>
        ...
        <tr>
            <td>
                <dx:ASPxGridView ID="gridMultiPlace" ClientInstanceName="gridMultiPlace" KeyFieldName="JHDM"
                    ...
                    <Columns>
                        <dx:GridViewCommandColumn VisibleIndex="0" Caption="删除" Width="50px">
                             <CustomButtons >
                                <dx:GridViewCommandColumnCustomButton ID="Delete" Text="删除" Visibility="Invisible"></dx:GridViewCommandColumnCustomButton>
                             </CustomButtons>
                            <ClearFilterButton Visible="true"></ClearFilterButton>
                        </dx:GridViewCommandColumn>
                        <dx:GridViewCommandColumn VisibleIndex="0" Caption=" " Width="70px">
                             <CustomButtons >
                                <dx:GridViewCommandColumnCustomButton ID="Replace" Text="加入替换" Visibility="Invisible"></dx:GridViewCommandColumnCustomButton>
                             </CustomButtons>
                             <CustomButtons >
