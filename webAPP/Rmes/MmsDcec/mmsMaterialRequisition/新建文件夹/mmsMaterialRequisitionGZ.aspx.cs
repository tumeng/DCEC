...
{
    public partial class mmsMaterialRequisitionGZ : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Session["mmsMaterialRequisitionGZ001"] = "";
            }
            if (Session["mmsMaterialRequisitionGZ001"] as string != "")
            {
                string sql = Session["mmsMaterialRequisitionGZ001"] as string;
        ...
        protected void cmbPlineCode_Init(object sender, EventArgs e)
        {
            ...
            string sql = "select pline_code,pline_name from vw_user_role_program a "
                + "where user_id='" + userId + "' and program_code='mmsMaterialRequisitionGZ' and company_code='" + companyCode 
                + "' ";
            dc.setTheSql(sql);
        ...
        protected void cmbPlan_Callback(object sender, DevExpress.Web.ASPxClasses.CallbackEventArgsBase e)
        {
            try
            {
                ...
                string sql = "SELECT DISTINCT plan_code,plan_code||';'||plan_so||';'||PLAN_QTY plan_desc "
                    ...
                    + "' and PLINE_CODE='" + cmbPline.Value.ToString() + "' and plan_type='C' order by plan_code";
        ...
        protected void ASPxGridView1_CustomCallback(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (cmbPlan.Text == "" && listPlan.Items.Count == 0)
            {
                ...
                {
                    BomReplaceFactory.QAD_CREATE_PRTPART("CALGZ", cmbPline.Value.ToString(), dt.Rows[i]["plan_so"].ToString(),
            ...
            if (listPlan.Items.Count > 0)
            {
                for (int i = 0; i < listPlan.Items.Count; i++)
                {
                    ...
                    BomReplaceFactory.QAD_CREATE_PRTPART("CALGZ", cmbPline.Value.ToString(), so,
            ...
            Session["mmsMaterialRequisitionGZ001"] = sql;
