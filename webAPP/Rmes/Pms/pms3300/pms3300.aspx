<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="pms3300.aspx.cs" Inherits="Rmes_pms3300" %>
...
<dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" ClientInstanceName="grid" Width="100%" KeyFieldName="SN"
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn Caption="开始时间" FieldName="WORK_TIME" VisibleIndex="19" Width="135px"/>
