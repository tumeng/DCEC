...
public partial class Rmes_pms3500 : BasePage
{
    ...
    private void DataBindGridview()
    {
        ...
        string sql = "select * from vw_data_complete t where exists(select * from data_project a where t.PROJECT_CODE=a.project_code and a.workshop_id='" + workShop[0].RMES_ID + "')";
