<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="pms3500.aspx.cs" Inherits="Rmes_pms3500" %>
...
<dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" ClientInstanceName="grid" Width="100%" KeyFieldName="SN"
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn Caption="质量状态" FieldName="QUALITY_STATUS" VisibleIndex="23" Width="60px"/>

        <dx:GridViewDataTextColumn Caption="核减状态" FieldName="ACCOUNT_FLAG" VisibleIndex="23" Width="60px" Visible="false"/>
        <dx:GridViewDataTextColumn Caption="单批数量" FieldName="BATCH_QTY" VisibleIndex="23" Width="60px" Visible="false"/>
