<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="epdQualityAlert.aspx.cs" Inherits="Rmes.WebApp.Rmes.EpdDCEC.epdQualityAlert.epdQualityAlert" StylesheetTheme="Theme1" %>
    ...
    <tr>
        <td>
            <dx:ASPxButton ID="ASPxButton1" runat="server" Text="新增" Width="120px">
                <ClientSideEvents Click="function(s,e){window.open('../epdQualityAlert/epdQualityAlertNew.aspx?opFlag=add&rmesId=');}" />
            </dx:ASPxButton>
        </td>
    </tr>
    <tr>
...
<dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" KeyFieldName="RMES_ID" 
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn Caption="质量警示类型" FieldName="NOTETYPE"   VisibleIndex="1" Width="150px"></dx:GridViewDataTextColumn>
        ...
        <dx:GridViewDataTextColumn Caption="质量警示内容" FieldName="QUALITY_ALERT" VisibleIndex="18"  Width="500px"></dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn Caption="图片" FieldName="ALERT_PIC" VisibleIndex="19"  Width="500px"></dx:GridViewDataTextColumn>
    ...
    <ClientSideEvents BeginCallback="function(s, e) 
        ...
        }" EndCallback="function(s, e) 
        {
            ...
            {
                window.open('../epdQualityAlert/epdQualityAlertNew.aspx?opFlag=edit&rmesId='+rmesId);
            }
        }" />
</dx:ASPxGridView>
        </td>
