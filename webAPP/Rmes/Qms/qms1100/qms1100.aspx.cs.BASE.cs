...
using Rmes.Web.Base;
    ...
    public partial class Rmes_qms1100 : Rmes.Web.Base.BasePage
	{
        ...
        protected void ASPxGridView1_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            ...
            detEntity.DETECT_DATA_CODE = e.NewValues["DETECT_DATA_CODE"].ToString().Trim();
            detEntity.DETECT_DATA_NAME = e.NewValues["DETECT_DATA_NAME"].ToString().Trim();
            ...
            if (e.NewValues["DETECT_DATA_STANDARD"] == null || e.NewValues["DETECT_DATA_STANDARD"].ToString().Trim() == "")
            {
                detEntity.DETECT_DATA_STANDARD = 0;
            }
            else
            {
                detEntity.DETECT_DATA_STANDARD = int.Parse(e.NewValues["DETECT_DATA_STANDARD"].ToString().Trim());
            }
            if (e.NewValues["DETECT_DATA_UP"] == null || e.NewValues["DETECT_DATA_UP"].ToString().Trim() == "")
            {
                detEntity.DETECT_DATA_UP = 0;
            }
            else
            {
                detEntity.DETECT_DATA_UP = int.Parse(e.NewValues["DETECT_DATA_UP"].ToString().Trim());
            }
            if (e.NewValues["DETECT_DATA_DOWN"] == null || e.NewValues["DETECT_DATA_DOWN"].ToString().Trim() == "")
            {
                detEntity.DETECT_DATA_DOWN = 0;
            }
            else
            {
                detEntity.DETECT_DATA_DOWN = int.Parse(e.NewValues["DETECT_DATA_DOWN"].ToString().Trim());
            }
