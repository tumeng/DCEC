<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="inf2200.aspx.cs" Inherits="Rmes.WebApp.Rmes.Interface.inf2200.inf2200" %>
...
<dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False" KeyFieldName="ID">
    ...
    <dx:GridViewCommandColumn VisibleIndex="0" Width="60px" >
        ...
        <dx:GridViewDataTextColumn Caption="线边库" FieldName="TLGORT" VisibleIndex="7" Width="250px"/>
        <dx:GridViewDataTextColumn Caption="来源库" FieldName="SLGORT" VisibleIndex="7" Width="250px"/>
