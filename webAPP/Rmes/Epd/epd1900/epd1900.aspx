<%@ Page Language="C#" MasterPageFile="~/MasterPage.master"  AutoEventWireup="true" Inherits="Rmes_epd1900" Codebehind="epd1900.aspx.cs" %>
...
<dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" ClientInstanceName="grid" KeyFieldName="RMES_ID"
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn Caption="部门代码" FieldName="DEPT_CODE" VisibleIndex="2" Width="80px" SortIndex="1" SortOrder="Ascending"/>
