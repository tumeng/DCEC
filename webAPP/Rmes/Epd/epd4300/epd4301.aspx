<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="epd4301.aspx.cs" Inherits="Rmes.WebApp.Rmes.Epd.epd4300.epd4301" %>
        ...
        <dx:ASPxTextBox ID="ASPxTextBox2" runat="server" Width="160px" Text='<%# Bind("COMPANY_CODE") %>' Visible="false"/>
                ...
                <tr style="height: 30px">
                    ...
                    <td style="width: 180px">
                        <dx:ASPxComboBox ID="ASPxComPline" runat="server" Width="160px" Value='<%# Bind("PLINE_CODE") %>'>
                            <ClientSideEvents SelectedIndexChanged="funtion (s,e){DataBind(s,e)}" />
                        </dx:ASPxComboBox>
                    </td>
                    <td style="width: 5px">
                    </td>
