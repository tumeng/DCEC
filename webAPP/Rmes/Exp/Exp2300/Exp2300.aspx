<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Exp2300.aspx.cs" Inherits="Rmes.WebApp.Rmes.Exp.Exp2300.Exp2300" %>
...
<body>
    ...
    <td width="160px">
        <dx:ASPxTextBox runat="server" ID="txtSN" Width="160px"></dx:ASPxTextBox>    
    </td>
    <td>
    ...
    <dx:ReportViewer ID="ReportViewer1" runat="server" 
        ...
        ReportName="Rmes.WebApp.Rmes.Exp.Exp2300.Report_Exp2300">
    </dx:ReportViewer>
    </form>
</body>
</html>
