...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table>
        <tr>
            ...
            <td>
                <dx:ASPxTextBox ID="Plan1" runat="server" ValueType="System.String" Width="100px"
                    SelectedIndex="0">
                </dx:ASPxTextBox>
            </td>
            <td>
            ...
            <td>
                <dx:ASPxTextBox ID="Plan2" runat="server" ValueType="System.String" Width="100px"
                    SelectedIndex="0">
                </dx:ASPxTextBox>
            </td>
        </tr>
   ...
   <%-- <table>
    ...
    <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" AutoGenerateColumns="True" KeyFieldName="ABOM_COMP"
