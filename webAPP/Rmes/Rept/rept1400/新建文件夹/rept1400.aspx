    ...
    <script type="text/javascript">
        function initEditSeries(s, e) {
            ...
            if (result == "") {
                ...
                //                DateEdit1.SetValue(array1[4]);
                //                DateEdit2.SetValue(array1[5]);
                    ...
                    <dx:ContentControl ID="ContentControl5" runat="server">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="流水号:">
                                    </dx:ASPxLabel>
                                </td>
                                <td>
                                    <dx:ASPxTextBox ID="txtSN5" runat="server" ValueType="System.String" Width="100px"
                                        ClientInstanceName="SN3">
                                        <ClientSideEvents TextChanged="function(s,e){  initEditSeries3(s, e);       }" />
                                    </dx:ASPxTextBox>
                                </td>
                                <td>
                                    <dx:ASPxButton ID="ASPxButton2" runat="server" AutoPostBack="False" Text="查询" Width="60px">
                                        <ClientSideEvents Click="function(s,e){
                        ...
                        <dx:ASPxGridView ID="ASPxGridView5" ClientInstanceName="grid5" runat="server" AutoGenerateColumns="true"
                            KeyFieldName="流水号" Width="100%" OnCustomCallback="ASPxGridView5_CustomCallback">
                            <ClientSideEvents BeginCallback="function(s, e) 
                                {
                            ...
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="流水号" FieldName="流水号" VisibleIndex="1" Width="110px"
                                    Settings-AutoFilterCondition="Contains">
                                    <Settings AutoFilterCondition="Contains"></Settings>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="站点" FieldName="站点" VisibleIndex="2" Width="100px"
                                    Settings-AutoFilterCondition="Contains">
                                    <Settings AutoFilterCondition="Contains"></Settings>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="扫描时间" FieldName="扫描时间" VisibleIndex="3" Width="150px"
                                    Settings-AutoFilterCondition="Contains">
                                    <Settings AutoFilterCondition="Contains"></Settings>
                                </dx:GridViewDataTextColumn>
                                ...
                                <dx:GridViewDataTextColumn Caption="零件号" FieldName="零件号" VisibleIndex="6" Width="120px"
                                    Settings-AutoFilterCondition="Contains">
                                    <Settings AutoFilterCondition="Contains"></Settings>
                                </dx:GridViewDataTextColumn>
                                ...
                                <dx:GridViewDataTextColumn Caption="供应商" FieldName="供应商" VisibleIndex="8" Width="120px"
                                    Settings-AutoFilterCondition="Contains">
                                    <Settings AutoFilterCondition="Contains"></Settings>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="条码" FieldName="条码" VisibleIndex="9" Width="250px"
                                    Settings-AutoFilterCondition="Contains">
                                    <Settings AutoFilterCondition="Contains"></Settings>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="FR" FieldName="FR" VisibleIndex="10" Width="100px" Visible="false"
                                    Settings-AutoFilterCondition="Contains">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption=" " VisibleIndex="99" Width="80%">
                                </dx:GridViewDataTextColumn>
