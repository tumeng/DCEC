...
namespace Rmes.WebApp.Rmes.Rept.rept3100
{
    public partial class rept3100 : BasePage
    {
        ...
        private void setCondition()
        {
            ...
            {
                int index = List1.Items.IndexOfText("--");
                //这里只取一行吗？
                string planCode = List1.SelectedItems[0].ToString().Substring(0, index);
            ...
            if (Check1.Checked == false && List1.Items.Count >= 1)
            {
                ...
                //int index = List1.Items.IndexOfText("2016P0926-01--SO22064");
                //test
                ...
                if (index >= 0)
                {
                    ...
                    {
                        index = List1.Items[i - 1].ToString().IndexOf("--");
                        sql += " OR B.PLAN_CODE = '" + List1.Items[i - 1].ToString().Substring(0, index) + "' ";
                    }
                    sql += ") ";
                }
            }
