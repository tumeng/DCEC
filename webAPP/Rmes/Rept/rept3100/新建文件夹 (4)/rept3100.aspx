...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxComboBox ID="cmbzd" runat="server" 
                                TextField="STATION_NAME" Width="120px" ClientInstanceName="cmbzd" 
                         ...
                         <td>
                            <%--？？清除按钮 --%>
                            <dx:ASPxButton ID="queryBill" runat="server" Text="在制品查询" AutoPostBack="false" Width="120px">
                                <ClientSideEvents Click="function(s, e){
                                    grid.PerformCallback();
                                    }"/>
                            </dx:ASPxButton>
    ...
    <dx:ASPxGridView ID="ASPxGridView1" runat="server" KeyFieldName="ROWID" ClientInstanceName="grid" OnCustomCallback="ASPxGridView1_CustomCallback" >
        <Columns>
            <dx:GridViewDataTextColumn Caption="流水号" FieldName="SN" VisibleIndex="2" Width="100px" Settings-AutoFilterCondition="Contains"
            ...
            <dx:GridViewDataTextColumn Caption="扫描时间" FieldName="START_TIME" VisibleIndex="4" Width="100px" Settings-AutoFilterCondition="Contains"
                CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="机型" FieldName="PRODUCT_MODEL" VisibleIndex="5" Width="100px" Settings-AutoFilterCondition="Contains"
                CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="站点名称" FieldName="STATION_NAME" VisibleIndex="6" Width="100px" Settings-AutoFilterCondition="Contains"
                CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="班次名称" FieldName="SHIFT_NAME" VisibleIndex="6" Width="100px" Settings-AutoFilterCondition="Contains"
                CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="班组名称" FieldName="TEAM_NAME" VisibleIndex="6" Width="100px" Settings-AutoFilterCondition="Contains"
                CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="员工名称" FieldName="USER_NAME" VisibleIndex="6" Width="100px" Settings-AutoFilterCondition="Contains"
                CellStyle-HorizontalAlign="Center">
            </dx:GridViewDataTextColumn>
        </Columns>
    </dx:ASPxGridView>
