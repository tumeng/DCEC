...
public partial class Rmes_Rept_rept3400_rept3400 : Rmes.Web.Base.BasePage
{
    ...
    public void ASPxGridView1_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
    {
        ...
        int PlanSl = 0;
        string snSql = "select distinct lsh,ptime from ATPUDQYQDYB where PTIME>=to_date('" + ASPxDateEdit1.Text.Trim() + "', 'yyyy-mm-dd hh24:mi:ss') and  PTIME<=to_date('" + ASPxDateEdit2.Text.Trim() + "', 'yyyy-mm-dd hh24:mi:ss') order by lsh,ptime";
