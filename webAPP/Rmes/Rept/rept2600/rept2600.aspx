...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" AutoGenerateColumns="true"
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="流水号" FieldName="SN" VisibleIndex="2" Width="100px"
            ...
            <dx:GridViewDataTextColumn Caption="工作日期" FieldName="WORK_TIME" VisibleIndex="9"
                Width="140px" Settings-AutoFilterCondition="Contains">
                <Settings AutoFilterCondition="Contains"></Settings>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="用户" FieldName="USER_ID" VisibleIndex="10" Width="80px"
                Settings-AutoFilterCondition="Contains">
                <Settings AutoFilterCondition="Contains"></Settings>
            </dx:GridViewDataTextColumn>
