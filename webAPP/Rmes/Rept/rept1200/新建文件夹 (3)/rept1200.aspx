...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table>
        <tr>
            ...
            <td>
                <dx:ASPxComboBox ID="txtPCode" runat="server" DataSourceID="SqlCode" TextField="PLINE_NAME" SelectedIndex="0"
                    ValueField="PLINE_CODE" ValueType="System.String" Width="170px" ClientInstanceName="PCode" >
            ...
            <td>
                <dx:ASPxComboBox ID="txtSCode" runat="server" DataSourceID="StationCode" TextField="STATION_NAME"
                    ValueField="STATION_CODE" ValueType="System.String" Width="170px" SelectedIndex ="0"
            ...
            <td>
                <dx:ASPxComboBox ID="txtChose" runat="server" ValueType="System.String" Width="140px"
        ...
        <tr>
            ...
            <td style="width: 100px">
                <dx:ASPxDateEdit ID="ASPxDateEdit1" runat="server" Width="170px" ClientInstanceName="DateEdit1" EditFormatString="yyyy-MM-dd HH:mm:ss">
            ...
            <td style="width: 140px">
                <dx:ASPxDateEdit ID="ASPxDateEdit2" runat="server" ClientVisible="false" Width="170px"
                    ClientInstanceName="DateEdit2" EditFormatString="yyyy-MM-dd HH:mm:ss">
                    <CalendarProperties ClearButtonText="清空" TodayButtonText="今天">
                    </CalendarProperties>
                </dx:ASPxDateEdit>
                <dx:ASPxComboBox ID="txtBc" runat="server" ValueType="System.String" Width="170px"
    ...
    <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
            <dx:GridViewDataTextColumn Caption="条码号" FieldName="GHTM" VisibleIndex="1" Width="120px"
                Settings-AutoFilterCondition="Contains">
                <Settings AllowHeaderFilter="True" AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="任务单" FieldName="JHDM" VisibleIndex="2" Width="120px"
                Settings-AutoFilterCondition="Contains">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="机型" FieldName="GGXHMC" VisibleIndex="3" Width="120px"
                Settings-AutoFilterCondition="Contains">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="SO" FieldName="SO" VisibleIndex="4" Width="120px"
                Settings-AutoFilterCondition="Contains">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="站点" FieldName="ZDMC" VisibleIndex="5" Width="120px"
                Settings-AutoFilterCondition="Contains">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="扫描时间" FieldName="RQSJ" VisibleIndex="6" Width="140px"
                Settings-AutoFilterCondition="Contains">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="员工" FieldName="YGMC" VisibleIndex="7" Width="100px"
                Settings-AutoFilterCondition="Contains">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="工作日期" FieldName="GZRQ" VisibleIndex="8" Width="140px"
                Settings-AutoFilterCondition="Contains">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="班次" FieldName="BCMC" VisibleIndex="9" Width="100px"
                Settings-AutoFilterCondition="Contains">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="班组" FieldName="BZMC" VisibleIndex="10" Width="100px"
                Settings-AutoFilterCondition="Contains">
            </dx:GridViewDataTextColumn>
