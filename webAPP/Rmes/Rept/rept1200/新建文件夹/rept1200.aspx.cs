...
namespace Rmes.WebApp.Rmes.Rept.rept1200
{
    public partial class rept1200 : BasePage
    {
        ...
        private void initCode()
        {
            ...
            string sql2 = "  select 'All'  as station_code,'全部' as station_name from code_station union select STATION_CODE,STATION_NAME from CODE_STATION order by STATION_NAME";
