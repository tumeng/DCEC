...
public partial class Rmes_rept1500 : Rmes.Web.Base.BasePage
{
    ...
    protected void setCondition()
    {
        ...
        if (txtPCode2.Text.Trim() != "")
        {
            ...
            //
            string ChSql = "select a.PLAN_SO,a.SN,a.WORK_TIME,c.complete_flag from data_product a ,data_plan b,data_complete c  where a.plan_code=b.plan_code and a.sn=c.sn and c.station_code like '%"+scode+"%' and a.WORK_DATE>=to_date('" + ASPxDateEdit3.Text.Trim() + "', 'yyyy-mm-dd hh24:mi:ss') "
