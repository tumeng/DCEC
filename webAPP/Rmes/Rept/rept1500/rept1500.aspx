<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    Theme="Theme1" CodeBehind="rept1500.aspx.cs" Inherits="Rmes_rept1500" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        function initEditSeries(s, e) {
            ...
            //                return;
            //            }
            var webFileUrl = "?CHOSE=" + CHOSE.GetText() + "&opFlag=getEditSeries";
            webFileUrl = encodeURI(encodeURI(webFileUrl));
            var result = "";
                    ...
                    <dx:ContentControl ID="ContentControl3" runat="server">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxTextBox ID="txtChose" runat="server" ValueType="System.String" Width="300px"
                                        ClientInstanceName="CHOSE">
                                        <ClientSideEvents TextChanged="function(s, e) { initEditSeries(s, e); }" />
<ClientSideEvents TextChanged="function(s, e) { initEditSeries(s, e); }"></ClientSideEvents>
                                    </dx:ASPxTextBox>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <PanelCollection>
                                            <dx:PanelContent ID="PanelContent4" runat="server">
                                                <dx:ASPxListBox ID="ASPxListBoxUnused" runat="server" ClientInstanceName="ListBoxUnused"
                                                    SelectionMode="CheckColumn" Width="300px" Height="240px" ValueField="DETECT_NAME"
