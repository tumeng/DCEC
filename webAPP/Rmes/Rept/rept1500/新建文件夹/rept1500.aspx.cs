...
public partial class Rmes_rept1500 : Rmes.Web.Base.BasePage
{
    ...
    protected void setCondition()
    {
        ...
        if (txtPCode2.Text.Trim() != "")
        {
            ...
            string planso = "", sn = "", wtime = "";
            string ChSql = "select a.PLAN_SO,a.SN,a.WORK_TIME from data_product a ,data_plan b  where a.plan_code=b.plan_code and a.WORK_DATE>=to_date('" + ASPxDateEdit3.Text.Trim() + "', 'yyyy-mm-dd hh24:mi:ss') "
            ...
            for (int i = 0; i < Chdt.Rows.Count; i++)
            {
                ...
                for (int j = 0; j < ASPxListBoxUsed.Items.Count; j++)
                {
                    ...
                    string ChSql2 = "Select a.DETECT_VALUE,b.STATION_NAME from data_sn_detect_data a ,code_station b  where a.station_code=b.station_code and  a.sn='" + sn + "' and a.DETECT_NAME='" + part2 + "'";
