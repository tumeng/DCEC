...
//            }
        ...
        <tr>
            ...
            <td>
                <dx:ASPxComboBox ID="txtPCode" runat="server" DataSourceID="SqlCode" TextField="PLINE_NAME"
                    ValueField="PLINE_CODE" ValueType="System.String" Width="100px" ClientInstanceName="plineCode" SelectedIndex="0">
                </dx:ASPxComboBox>
            </td>
            <td>
    ...
    <table>
        <tr>
            ...
            <td>
                <dx:ASPxButton ID="btnExport" runat="server" Text="导出" Width="100px" AutoPostBack="false"
                    ><%--OnClick="btnExport_Click"--%>
                    <ClientSideEvents Click="function(s, e){
                        grid.PerformCallback('XLS|xls');
                        }"/>
                </dx:ASPxButton>
            </td>
        </tr>
    ...
    <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="保管员" FieldName="BGY" VisibleIndex="8" Width="80px"
                ...
                {
                  if(callbackValue.substring(0,8)=='Restruct')
