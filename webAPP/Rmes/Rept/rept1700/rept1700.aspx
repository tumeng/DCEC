...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <dx:ASPxGridView ID="ASPxGridView2" ClientInstanceName="grid2" runat="server" AutoGenerateColumns="False"
        Width="300px" KeyFieldName="LJDM1;LJDM2" OnCustomCallback="ASPxGridView2_CustomCallback">
            <columns>
            <dx:GridViewDataTextColumn Caption="原零件" FieldName="LJDM1" VisibleIndex="1" Width="100px"
