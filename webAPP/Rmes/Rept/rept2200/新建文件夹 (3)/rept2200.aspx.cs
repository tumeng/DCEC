...
namespace Rmes.WebApp.Rmes.Rept.rept2200
{
    public partial class rept2200 : BasePage
    {
        ...
        private void setCondition()
        {
            ...
            if (txtSN.Text.Trim() != "")
            {
                string gzsql = "select sn from data_record where sn='" + txtSN.Text.Trim() + "'";
                DataTable gzdt = dc.GetTable(gzsql);
            ...
            string sql = "SELECT a.SN ,a.station_name ,a.create_time , b.user_name,a.pline_code ,a.item_code ,a.item_sn ,a.item_name ,a.item_vendor ,"
                         + " a.barcode   FROM data_scan_item a left join code_user b on a.CREATE_USERID=b.USER_CODE   WHERE a.SN='" + txtSN.Text.Trim() + "'";
        ...
        protected void ASPxGridView1_CustomCallback(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                string sql = " select sn from DATA_SN_BOM where sn in( select b.sn from data_plan a left join data_plan_sn b on a.plan_code=b.plan_code  where a.plan_type='C') ";
