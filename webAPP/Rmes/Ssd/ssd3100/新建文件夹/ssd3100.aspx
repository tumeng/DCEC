            ...
            <dx:PanelContent ID="PanelContent6" runat="server">
                <table style="background-color: #99bbbb; width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="width: 100px">
                            <dx:ASPxButton ID="ASPxButton1" runat="server" AutoPostBack="true" Text="替换" Width="100px">
                        ...
                        <td style="text-align: right;">
                            <dx:ASPxButton ID="ASPxButton3" runat="server" AutoPostBack="true" Text="对调" Width="100px">
                                <ClientSideEvents Click="function (s,e){
                                                                        SnTh1();
                                                                    }" />
                            </dx:ASPxButton>
                    ...
                    <tr>
                        ...
                        <td style="width: 5px">
                         ...
                         <td>
                            <dx:ASPxButton ID="ASPxButton2" runat="server" AutoPostBack="true" Text="批量替换" Width="100px">
                                <ClientSideEvents Click="function (s,e){
                                                                        SnThMulti();
                                                                    }" />
                            </dx:ASPxButton>
