<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="ssd1042.aspx.cs" Inherits="Rmes.WebApp.Rmes.Ssd.ssd1042" %>
    ...
    <script type="text/javascript">
        ...
        function ShowPopup1() {
            ...
            if (count < 1) {
                ...
                var filedNames = "PLINE_CODE;PLAN_SO;PRODUCT_MODEL;PLAN_CODE;PLAN_QTY;REMARK1;CJZD";
...
<%--        <SettingsPager Mode="ShowAllRecords">
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="拆解站点" FieldName="CJZD" Width="100px"
                Settings-AllowHeaderFilter="True">
                <Settings AllowHeaderFilter="True"></Settings>
            </dx:GridViewDataTextColumn>
           ...
           <dx:GridViewDataDateColumn Caption="结束日期" FieldName="END_DATE" Width="75px" CellStyle-Wrap="False"
            ...
            <dx:GridViewDataDateColumn Caption="记账日期" FieldName="ACCOUNT_DATE" Width="75px" CellStyle-Wrap="False"  Visible="false"
                Settings-AllowHeaderFilter="True">
                <Settings AllowHeaderFilter="True"></Settings>
                <CellStyle Wrap="False">
                </CellStyle>
            ...
            <EditForm>
                <table>
                    ...
                    <tr style="height: 30px">
                        ...
                        <td>
                            <dx:ASPxLabel ID="ASPxLabel19" runat="server" Text="拆解站点"  AssociatedControlID="ASPxComboBox1">
                            </dx:ASPxLabel>
                        </td>
                        <td style="width: 180px" align="left">
                            <dx:ASPxComboBox ID="ASPxComboBox1" runat="server"  ClientInstanceName="EditType" EnableClientSideAPI="True" Value='<%# Bind("CJZD") %>'
                                DataSourceID="SqlDataSource3" ValueType="System.String" Width="150px" 
                                TextField="STATION_NAME" ValueField="STATION_CODE" ValidationSettings-ValidationGroup="<%# Container.ValidationGroup %>">
                                <ValidationSettings SetFocusOnError="True" ValidateOnLeave="True" ErrorDisplayMode="ImageWithTooltip">
                                    <RequiredField IsRequired="True" ErrorText="拆解站点不能为空！" />
                                </ValidationSettings>
                            </dx:ASPxComboBox>
                        </td>
                        <td>
...
<%--                    <tr style="height: 30px">
    ...
    <td><dx:ASPxLabel runat="server" ID="ASPxLabel61" runat="server" ForeColor="Blue" Text="BOM转换 |"></dx:ASPxLabel>&nbsp&nbsp</td>
            ...
            <dx:PopupControlContentControl Width="100%">
                <table align="center" style="width: 800px; height: 200px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxComboBox ID="CJZD" runat="server" Width="120px" ClientInstanceName="CJZD" AutoPostBack="false" DropDownStyle="DropDownList" >
            ...
            <dx:PopupControlContentControl Width="100%">
                <table align="center" style="width: 800px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxTextBox ID="ASPxTextBox7" ClientInstanceName="Panel1_PlanType" runat="server"
                                Width="120px"  />
                        </td>
                        <td style="width: 5px">
                        </td>
...
<%--                                                    <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text="输入流水号" Width="30px">
                                                                </dx:ASPxLabel>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="height: 180px">
                                                                                                                    ...
                                                                                                                    <dx:ASPxLabel ID="ASPxLabel8" runat="server" Text="输入流水号" Width="30px">
                                                                </dx:ASPxLabel>
                                                </td>
                                                <td style="width: 5px">
                                                </td>
