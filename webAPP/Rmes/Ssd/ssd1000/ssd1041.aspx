<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="ssd1041.aspx.cs" Inherits="Rmes.WebApp.Rmes.Ssd.ssd1041" %>
...
<%--                                <ClientSideEvents Click="function (s,e){
                        ...
                        <td style="text-align: right;">
                            <a href="C:\\计划模板\\改制计划模板.xls">计划模板</a>
                        </td>
                        <td style="width: auto;">
                        </td>
                    </tr>
            ...
            <dx:PopupControlContentControl Width="100%">
                <table align="center" style="width: 800px; height: 200px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxComboBox ID="CJZD" runat="server" Width="120px" ClientInstanceName="CJZD" AutoPostBack="false">
            ...
            <dx:PopupControlContentControl Width="100%">
                <table align="center" style="width: 800px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxTextBox ID="ASPxTextBox8" ClientInstanceName="Panel1_BOM" runat="server"
                                Width="120px"  />
                        </td>
                        <td style="width: 5px">
                        </td>
