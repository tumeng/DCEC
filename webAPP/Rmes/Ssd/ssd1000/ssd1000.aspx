<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="ssd1000.aspx.cs" Inherits="Rmes.WebApp.Rmes.Ssd.ssd1000" %>
...
//            Series.PerformCallback(txtSO.GetValue());
        ...
        function initEditSeries(s, e) {
            ...
            ASPxComboBoxAcross11.PerformCallback(s.GetValue());
        }
        ...
        function ShowPopup1() {
            ...
            if (count < 1) {
                ...
                grid.GetSelectedFieldValues("CONFIRM_FLAG", GetValues11)
            }
        }
        function GetValues11(values) {
            if (values[0] != "N") {
                alert("计划已确认无法更改流水号");
                return;
            }
...
//                CallbackSubmit.PerformCallback(ref);
        ...
        function GetValues(values) {
            ...
            labelqty.SetValue('0');
            popup1.Show();
            if (values[0][5].indexOf('预留号')>0) {
                butYlh.SetEnabled(true);
            }
            else {
                butYlh.SetEnabled(false);
            }
...
//                butZXC.SetEnabled(false);
                var fieldNames = "RMES_ID";
                grid2.GetSelectedFieldValues(fieldNames, UpResult);
            }
        }
        function MoveDown() {
            var count = grid2.GetSelectedRowCount();
            if (count != 1) {
                ...
                //                butZXC.SetEnabled(false);
                var fieldNames = "RMES_ID";
                grid2.GetSelectedFieldValues(fieldNames, DownResult);
            }
        }
        function UpResult(result) {
            if (result == "") {
                alert('没有选择任何计划！无法进行操作');
            }
            else {
                var ref = "MoveUp," + result;
                CallbackSubmit.PerformCallback(ref);
            }
        }
        function DownResult(result) {
            if (result == "") {
                alert('没有选择任何计划！无法进行操作');
            }
            else {
                var ref = "MoveDown," + result;
                CallbackSubmit.PerformCallback(ref);
            }
        }
    </script>
...
<%--                                <ClientSideEvents Click="function (s,e){
                        ...
                        <td style="text-align: right;">
                            <%--<a href="C:\\计划模板\\计划模板.xls">计划模板</a>--%>
                            <a href="../../File/计划模板.xls">计划模板</a>
                        </td>
                        <td style="width: auto;">
                        </td>
                    </tr>
    ...
    <table style="background-color: #99bbbb; width: 100%;">
        <tr>
            ...
            <td style="width: 120px">
                <dx:ASPxDateEdit ID="ASPxDateEdit1" runat="server" EditFormatString="yyyy-MM-dd"
                    ...
                    <ClientSideEvents DateChanged="function(s,e){
                        ...
                        dateSeqPanel.PerformCallback();
                        datePcodePanel.PerformCallback();
                    }" />
                </dx:ASPxDateEdit>
            </td>
            <td style="width: 5px">
            ...
            <td style="width: 120px;">
                <dx:ASPxButton ID="ASPxButton3" Text="自动生成流水号" Width="150px" AutoPostBack="false" ClientInstanceName="autosn"
                    runat="server">
                    <ClientSideEvents Click="function(s,e){
                       ShowPopup2();     
                    }" />
        ...
        <tr>
            ...
            <td style="text-align: left; width: 70px;">
                <dx:ASPxButton ID="ASPxButton6" Text="调序" Width="90px" AutoPostBack="false" runat="server">
                    <ClientSideEvents Click="function(s,e){
                        grid2.PerformCallback();
                        popup3.Show();
...
<%--            <td style="text-align: left; width: 70px;">
                <dx:ASPxButton ID="ASPxButton4" Text="上移" Width="150px" AutoPostBack="false" ClientInstanceName="moveup1"
                    runat="server">
                    <ClientSideEvents Click="function(s,e){
                       MoveUp();     
                    }" />
            ...
            <td style="text-align: left; width: 70px;">
                <dx:ASPxButton ID="ASPxButton5" Text="下移" Width="150px" AutoPostBack="false" ClientInstanceName="movedown1"
                    runat="server">
                    <ClientSideEvents Click="function(s,e){
                       MoveDown();     
                    }" />
...
<SelectButton Text="选择"></SelectButton>
            ...
            <dx:GridViewDataTextColumn Caption="入库数" FieldName="RKSL" Width="70px" CellStyle-HorizontalAlign="Right"
                Settings-AllowHeaderFilter="True">
                <Settings AllowHeaderFilter="True"></Settings>
                <CellStyle HorizontalAlign="Right">
                </CellStyle>
...
<PropertiesDateEdit DisplayFormatString="yyyy-MM-dd HH:mm:ss"></PropertiesDateEdit>
           ...
           <dx:GridViewDataTextColumn Caption="客户" FieldName="CUSTOMER_NAME" Width="80px"
            ...
            <dx:GridViewDataTextColumn Caption="备注" Width="200px">
                <DataItemTemplate>
                    <a href="javascript:void(0);" onclick="OnMoreInfoClick(this, '<%# Container.KeyValue %>')">
                        <%#ConvertFormat(Eval("REMARK").ToString())%></a>
                </DataItemTemplate>
            </dx:GridViewDataTextColumn>
            <%--<dx:GridViewDataTextColumn Caption="备注" FieldName="REMARK" Width="100px" CellStyle-Wrap="False" Visible="false"
                Settings-AllowHeaderFilter="True">
                <Settings AllowHeaderFilter="True"></Settings>
                <CellStyle Wrap="False">
                </CellStyle>
                ...
                <table>
                    ...
                    <tr style="height: 30px">
                        ...
                        <td style="width: 180px" align="left">
                            <dx:ASPxComboBox ID="PlineCombo" runat="server"  EnableClientSideAPI="True" Enabled="false"  Value='<%# Bind("PLINE_CODE") %>'
                    ...
                    <tr style="height: 30px">
                        ...
                        <td style="width: 180px" align="left">
                            <dx:ASPxComboBox ID="ASPxComboBoxAcross1" runat="server"  ClientInstanceName="ASPxComboBoxAcross11" 
                                EnableClientSideAPI="True"  Value='<%# Bind("ROUNTING_CODE") %>' DropDownStyle="DropDownList"
                                DataSourceID="SqlDataSource2" ValueType="System.String" Width="150px"  
                                TextField="ALINE_NAME" ValueField="ALINE_CODE" 
                                ValidationSettings-ValidationGroup="<%# Container.ValidationGroup %>" 
                                oncallback="ASPxComboBoxAcross1_Callback">
<%--                                <ValidationSettings SetFocusOnError="True" ValidateOnLeave="True" ErrorDisplayMode="ImageWithTooltip">
            ...
            <dx:PopupControlContentControl Width="100%">
                <table align="center" style="width: 800px; height: 200px;">
                    <tr>
                        ...
                        <td>
                            <dx:ASPxCallbackPanel runat="server" ID="ASPxCallbackPanel9" ClientInstanceName="dateSeqPanel"
                                OnCallback="ASPxCallbackPanel9_Callback">
                                <PanelCollection>
                        ...
                        <td>
                            <dx:ASPxCallbackPanel runat="server" ID="ASPxCallbackPanel10" ClientInstanceName="datePcodePanel"
                                OnCallback="ASPxCallbackPanel10_Callback">
                                <PanelCollection>
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            <%--<dx:ASPxTextBox ID="ASPxTextBoxRemark" ClientInstanceName="txtRemark" runat="server"
                                Width="200px" />--%>
                                <dx:ASPxMemo ID="aspxmemoRemark" runat="server" Text="" Width="100%"  ClientInstanceName="txtRemark"
                                Border-BorderStyle="None" Height="100px">
<Border BorderStyle="Solid"></Border>
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxCallbackPanel runat="server" ID="ASPxCallbackPanel8" ClientInstanceName="ProcessPanel8"
                                OnCallback="ASPxCallbackPanel8_Callback">
                                <PanelCollection>
                                    <dx:PanelContent ID="PanelContent8" runat="server">
                                        <dx:ASPxComboBox ID="ASPxComboBoxAcross" ClientInstanceName="listAcross" runat="server"
            ...
            <dx:PopupControlContentControl Width="100%">
                <table align="center" style="width: 800px;">
                    <tr>
                        ...
                        <td>
                            <dx:ASPxTextBox ID="ASPxTextBox1" ClientInstanceName="Panel1_Pline" runat="server"
                                 Width="120px" />
                        </td>
                        <td style="width: 5px">
                        </td>
                        ...
                        <td>
                            <dx:ASPxTextBox ID="ASPxTextBox2" ClientInstanceName="Panel1_SO" runat="server" Width="120px"
                                 />
                        </td>
                        <td style="width: 5px">
                        </td>
                        ...
                        <td>
                            <dx:ASPxTextBox ID="ASPxTextBox3" ClientInstanceName="Panel1_Series" runat="server"
                                Width="120px" >
                            </dx:ASPxTextBox>
                        </td>
                        <td style="width: auto">
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxTextBox ID="ASPxTextBox5" ClientInstanceName="Panel1_PlanCode" runat="server"
                                Width="120px"  />
                        </td>
                        <td style="width: 5px">
                        </td>
                        ...
                        <td>
                            <dx:ASPxTextBox ID="ASPxTextBox6" ClientInstanceName="Panel1_Qty" runat="server"
                                Width="120px"  />
                        </td>
                        <td style="width: 5px">
                        </td>
                        ...
                        <td>
                            <dx:ASPxTextBox ID="ASPxTextBox4" ClientInstanceName="Panel1_Remark" runat="server"
                                Width="120px" />
                        </td>
                        <td style="width: auto">
                        </td>
                        ...
                        <dx:PanelContent ID="PanelContent5" runat="server">
                            ...
                            <table align="center" style="width: 800px;">
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxLabel ID="L1" runat="server" Text="预留号">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td style="width: 5px">
                                    </td>
                                    ...
                                    <td>
                                        <dx:ASPxLabel ID="ASPxLabel8" runat="server" Text="分配数量">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td style="width: 5px">
                                    </td>
                                    <td>
                                        <dx:ASPxTextBox ID="YLHsl" runat="server" Width="40px" Text="1" ClientInstanceName="YLHsl">
                                            <ValidationSettings SetFocusOnError="True" ValidateOnLeave="True" ErrorText="请输入一个有效的数字！"
                                                ErrorDisplayMode="ImageWithTooltip">
                                                <RegularExpression ErrorText="请输入一个有效的数字！" ValidationExpression="^\d*$" />
                                            </ValidationSettings>
                                        </dx:ASPxTextBox>
                                    </td>
                                    <td style="width: 5px">
                                    ...
                                    <td>
                                        <dx:ASPxButton ID="bt_YLH" runat="server" Text="预留号分配" Width="100px" AutoPostBack="false" 
                                            ClientInstanceName="butYlh">
                                            <ClientSideEvents Click="function(s,e) { checkYlh(); }" />
                                        </dx:ASPxButton>
                                    </td>
                                    <td style="width: 100px">
                                    </td>
    ...
    <dx:ASPxPopupControl ID="ASPxPopupControl3" ClientInstanceName="popup3" runat="server"
        PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" CloseAction="CloseButton"
        ShowHeader="True" HeaderText="调序" AllowDragging="true" Width="80%">
        <ClientSideEvents CloseUp="function(s, e) { grid.PerformCallback(); }" />
        <ContentCollection>
            <dx:PopupControlContentControl Width="100%">
                <table align="center" style="width: 800px; height: 200px;">
                    <tr>
                        ...
                        <td>
                            <dx:ASPxGridView ID="ASPxGridView2" ClientInstanceName="grid2" runat="server" KeyFieldName="RMES_ID"
                                SettingsPager-Mode="ShowAllRecords" AutoGenerateColumns="False" OnCustomCallback="ASPxGridView2_CustomCallback">
                                <Columns>
                                    <dx:GridViewCommandColumn ShowSelectCheckbox="true" SelectButton-Text="选择" Caption="选择"
                                        Width="40px">
                                        <HeaderTemplate>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="RMES_ID" Visible="false" />
                                    <dx:GridViewDataTextColumn Caption="计划编号" FieldName="PLAN_CODE" Width="100px" CellStyle-HorizontalAlign="Center"
                                        Settings-AllowHeaderFilter="True">
                                        <Settings AutoFilterCondition="Contains" />
                                        <CellStyle HorizontalAlign="Center">
                                        </CellStyle>
                        ...
                        <td style="text-align: left; width: 70px">
                            <table>
                                <tr>
                                    <td colspan="5" align="center">
                                        <dx:ASPxButton ID="ASPxButton7" ClientInstanceName="moveup1" Text="上移" AutoPostBack="false"
                                            runat="server" Width="80px">
                                            <ClientSideEvents Click="function(s,e) { MoveUp(); }" />
                                        </dx:ASPxButton>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="5" align="center">
                                        <dx:ASPxButton ID="ASPxButton8" ClientInstanceName="movedown1" Text="下移" AutoPostBack="false"
                                            runat="server" Width="80px">
                                            <ClientSideEvents Click="function(s,e) { MoveDown(); }" />
                                        </dx:ASPxButton>
                                    </td>
                                </tr>
                            </table>
                ...
                <dx:ASPxCallback ID="ASPxCallback1" runat="server" ClientInstanceName="CallbackSubmit"
                    OnCallback="ASPxCbSubmit_Callback">
                    <ClientSideEvents CallbackComplete="function(s, e) { submitRtr(e.result); }" />
                </dx:ASPxCallback>
            </dx:PopupControlContentControl>
