...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False" KeyFieldName="RMES_ID"
        ...
        <SettingsPager Mode="ShowPager"></SettingsPager>
         ...
         <TotalSummary>
            <dx:ASPxSummaryItem FieldName="PLAN_QTY" SummaryType="Sum" DisplayFormat="计划总数={0}"/>
            <dx:ASPxSummaryItem FieldName="ONLINE_QTY" SummaryType="Sum" DisplayFormat="计划上线数={0}"/>
            <dx:ASPxSummaryItem FieldName="OFFLINE_QTY" SummaryType="Sum" DisplayFormat="计划下线数={0}"/>
            <dx:ASPxSummaryItem FieldName="FZQTY" SummaryType="Sum" DisplayFormat="附装上线数={0}"/>
        </TotalSummary>
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="生产线" FieldName="PLINE_CODE" VisibleIndex="2" Width="50px" Settings-AutoFilterCondition="Contains"/>

            <dx:GridViewDataTextColumn Caption="生产线" FieldName="PLINE_NAME" Visible="false" VisibleIndex="3" Width="60px" Settings-AutoFilterCondition="Contains"/>

            <dx:GridViewDataTextColumn Caption="计划序" FieldName="PLAN_SEQ" VisibleIndex="0" Width="50px" CellStyle-HorizontalAlign="Left"  Settings-AutoFilterCondition="Contains"/>
            ...
            <dx:GridViewDataTextColumn Caption="SO" FieldName="PLAN_SO" Width="90px" Settings-AutoFilterCondition="Contains">
            ...
            <dx:GridViewDataTextColumn Caption="计划类型" FieldName="PLAN_TYPE" Visible="false" Width="80px" Settings-AutoFilterCondition="Contains"/>

            <dx:GridViewDataTextColumn Caption="用户代码" FieldName="USER_CODE" Visible="false" Width="80px" CellStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains"/>

            <dx:GridViewDataTextColumn Caption="用户姓名" FieldName="CREATE_USERNAME" Visible="false" Width="80px" CellStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains"/>

            <dx:GridViewDataTextColumn Caption="计划制定日期" FieldName="CREATE_TIME" Visible="false" Width="130px" PropertiesTextEdit-DisplayFormatString="yyyy/MM/dd" CellStyle-Wrap="False" Settings-AutoFilterCondition="Contains"/>
            <dx:GridViewDataTextColumn Caption="计划开始日期" FieldName="BEGIN_DATE" Width="120px" PropertiesTextEdit-DisplayFormatString="yyyy/MM/dd" CellStyle-Wrap="False" Settings-AutoFilterCondition="Contains"/>
            <dx:GridViewDataTextColumn Caption="计划结束日期" FieldName="END_DATE" Visible="false" Width="130px" PropertiesTextEdit-DisplayFormatString="yyyy/MM/dd" CellStyle-Wrap="False" Settings-AutoFilterCondition="Contains"/>

            <dx:GridViewDataTextColumn Caption="实际开工时间" FieldName="BEGIN_TIME" Visible="false" Width="130px" PropertiesTextEdit-DisplayFormatString="yyyy/MM/dd" CellStyle-Wrap="False" Settings-AutoFilterCondition="Contains"/>
            <dx:GridViewDataTextColumn Caption="实际完工时间" FieldName="END_TIME" Visible="false" Width="130px" PropertiesTextEdit-DisplayFormatString="yyyy/MM/dd" CellStyle-Wrap="False" Settings-AutoFilterCondition="Contains"/>

            <dx:GridViewDataTextColumn Caption="记账日期" FieldName="ACCOUNT_DATE" Visible="false" Width="130px" PropertiesTextEdit-DisplayFormatString="yyyy/MM/dd" CellStyle-Wrap="False" Settings-AutoFilterCondition="Contains"/>

            <dx:GridViewDataTextColumn Caption="计划数量" FieldName="PLAN_QTY" Width="80px"  CellStyle-HorizontalAlign="Left"  Settings-AutoFilterCondition="Contains"/>

            <dx:GridViewDataTextColumn Caption="计划上线数量" FieldName="ONLINE_QTY" Width="80px"  CellStyle-HorizontalAlign="Left"  Settings-AutoFilterCondition="Contains"/>
            <dx:GridViewDataTextColumn Caption="计划下线数量" FieldName="OFFLINE_QTY" Width="80px" CellStyle-HorizontalAlign="Left" Settings-AutoFilterCondition="Contains"/>
            <dx:GridViewDataTextColumn Caption="附装上线数量" FieldName="FZQTY" Width="80px"  CellStyle-HorizontalAlign="Left"  Settings-AutoFilterCondition="Contains"/>
            <dx:GridViewDataTextColumn Caption="计划确认标识" FieldName="CONFIRM_FLAG" Visible="false" Width="100px" CellStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains"/>
            <dx:GridViewDataTextColumn Caption="BOM转换" FieldName="BOM_FLAG" Visible="false" Width="100px" CellStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains"/>
            <dx:GridViewDataTextColumn Caption="库房确认标识" FieldName="ITEM_FLAG" Visible="false" Width="100px" CellStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains"/>
            <dx:GridViewDataTextColumn Caption="是否分配流水号" FieldName="SN_FLAG" Visible="false" Width="100px" CellStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains"/>
            <dx:GridViewDataTextColumn Caption="三方要料" FieldName="THIRD_FLAG" Visible="false" Width="100px" CellStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" />
            ...
            <dx:GridViewDataTextColumn Caption="生产确认标识" FieldName="RUN_FLAG" Visible="false" Width="100px" CellStyle-HorizontalAlign="Center" Settings-AutoFilterCondition="Contains" />

            <dx:GridViewDataTextColumn Caption="工艺地点" FieldName="ROUNTING_SITE" Visible="false" Width="100px" CellStyle-Wrap="False" Settings-AutoFilterCondition="Contains" />
            ...
            <dx:GridViewDataTextColumn Caption="客户名称" FieldName="CUSTOMER_NAME" Width="140px" CellStyle-Wrap="False" Settings-AutoFilterCondition="Contains" />

            <dx:GridViewDataTextColumn Caption="备注" FieldName="REMARK" Width="140px" CellStyle-Wrap="False" Settings-AutoFilterCondition="Contains">
                <DataItemTemplate>
            ...
            <dx:GridViewDataTextColumn Caption="工艺路线代码" FieldName="ROUNTING_CODE" Visible="false" Width="100px" CellStyle-Wrap="False" Settings-AutoFilterCondition="Contains" />

            <dx:GridViewDataTextColumn Caption="柳汽标识" FieldName="LQ_FLAG" Visible="false" Width="100px" CellStyle-Wrap="False" Settings-AutoFilterCondition="Contains" />

            <dx:GridViewDataTextColumn Caption="改制返修是否转BOM" FieldName="IS_BOM" Visible="false" Width="120px" CellStyle-Wrap="False" Settings-AutoFilterCondition="Contains" />
