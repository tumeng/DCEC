...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False" KeyFieldName="RMES_ID"
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="上线数量" FieldName="ONLINE_QTY" Width="80px"  CellStyle-HorizontalAlign="Left"  Settings-AutoFilterCondition="Contains"/>
            <dx:GridViewDataTextColumn Caption="下线数量" FieldName="OFFLINE_QTY" Width="80px" CellStyle-HorizontalAlign="Left" Settings-AutoFilterCondition="Contains"/>
            <dx:GridViewDataTextColumn Caption="附装上线数量" FieldName="FZQTY" Width="100px"  CellStyle-HorizontalAlign="Left"  Settings-AutoFilterCondition="Contains"/>
