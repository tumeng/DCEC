<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="ssd1100.aspx.cs" Inherits="Rmes.WebApp.Rmes.Ssd.ssd1100.ssd1100" %>
    ...
    <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" KeyFieldName="RMES_ID"
        ...
        <Columns>
            ...
            <dx:GridViewCommandColumn Caption="操作" Width="120px" ButtonType="Link">
                <CustomButtons>
                    <dx:GridViewCommandColumnCustomButton ID="Cbt1" Text="接    收" >
                    </dx:GridViewCommandColumnCustomButton>
                    <dx:GridViewCommandColumnCustomButton ID="Cbt2" Text="取消接收">
                    </dx:GridViewCommandColumnCustomButton>
                </CustomButtons>
            </dx:GridViewCommandColumn>
