...
{
    public class Class2 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        {
            InitializeComponent();
            string _b = DateTime.Now.ToShortDateString() + " 00:00:00";
            string _e = DateTime.Now.ToShortDateString() + " 23:59:59";
            List<PlanEntity> plans = DB.GetInstance().Fetch<PlanEntity>("where create_time between to_date(@0,'yyyy-mm-dd hh24:mi:ss') and to_date(@1,'yyyy-mm-dd hh24:mi:ss')",_b,_e);
            this.DataSource = plans;
            this.xrTableCell4.DataBindings.Add("Text", DataSource, "ORDER_CODE");
            this.xrTableCell5.DataBindings.Add("Text", DataSource, "PLAN_SO");
            this.xrTableCell6.DataBindings.Add("Text", DataSource, "PROJECT_CODE");
