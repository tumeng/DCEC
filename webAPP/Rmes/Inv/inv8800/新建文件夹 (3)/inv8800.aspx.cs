    ...
    public partial class inv8800 : BasePage
    {
        ...
        public void ASPxGridView1_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            try
            {
                ...
                string sql1 = "select distinct to_char(begin_date,'yyyy-mm-dd'),plan_code ,plan_so,plan_qty,plan_seq from data_plan where pline_code='" + txtPCode.Value.ToString() + "'"
                              ...
                              + "and plan_type<>'C' and plan_type<>'D' order by plan_seq,plan_code";
