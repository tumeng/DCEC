<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="inv8800.aspx.cs" Inherits="Rmes.WebApp.Rmes.Inv.inv8800.inv8800" %>
            ...
            <dx:PanelContent ID="PanelContent5" runat="server">
                ...
                <table>
                    <tr>
                        ...
                        <td style="width: 100px">
                            <dx:ASPxDateEdit ID="ASPxDateEdit2" runat="server" ClientVisible="true" Width="120px"
                ...
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="true" ClientInstanceName="grid"
                    ...
                    OnInit="ASPxGridView1_Init" OnPageIndexChanged="ASPxGridView1_PageIndexChanged"  --%>
                    <SettingsBehavior AllowSort="false" />
