<%@ Page Title="期初库存设定" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeBehind="inv8600.aspx.cs" Inherits="Rmes.WebApp.Rmes.Inv.inv8600.inv8600" %>
            ...
            <dx:PanelContent ID="PanelContent6" runat="server">
                <table style="background-color: #99bbbb;width: 100%">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label1" runat="server" Width="120px" Text="打开Txt文件"></asp:Label>
                        </td>
                        <td>
...
<%--                                <ClientSideEvents Click="function (s,e){
                        ...
                        <td>
                            <dx:ASPxLabel ID="ASPxLabel10" runat="server" Width="150px" Text="设置期初时间:"></dx:ASPxLabel>
                        </td>
                        <td>
                            <dx:ASPxDateEdit ID="ToRq" runat="server" EditFormatString="yyyy-MM-dd"
                                Width="120px">
                            </dx:ASPxDateEdit>
                        </td>
                        <td>
                            <dx:ASPxButton ID="ASPxButton_Confirm" runat="server" Text="设为期初库存" Width="150px">
    ...
    <dx:ASPxGridView ID="ASPxGridView1" runat="server" KeyFieldName="ROWID" ClientInstanceName="grid" AutoGenerateColumns="False"
