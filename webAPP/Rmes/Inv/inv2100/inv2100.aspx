<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="inv2100.aspx.cs" Inherits="Rmes.WebApp.Rmes.Inv.inv2100.ssd2100" %>
...
<dx:ASPxGridView ID="ASPxGridView1" runat="server" ClientInstanceName="grid" AutoGenerateColumns="False" KeyFieldName="RMES_ID"
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn Caption="物料代码" FieldName="ITEM_CODE" VisibleIndex="1" Width="100px"/>
        <dx:GridViewDataTextColumn Caption="物料数量" FieldName="ITEM_QTY" VisibleIndex="1" Width="100px"/>
        <dx:GridViewDataTextColumn Caption="工厂" FieldName="FACTORY_CODE" VisibleIndex="1" Width="100px"/>
        <dx:GridViewDataTextColumn Caption="线边库" FieldName="STORE_CODE" VisibleIndex="1" Width="100px"/>
        <dx:GridViewDataTextColumn Caption="生产线" FieldName="PLINE_CODE" VisibleIndex="1" Width="100px"/>
        <dx:GridViewDataTextColumn Caption="工位" FieldName="LOCATION_CODE" VisibleIndex="1" Width="100px"/>
