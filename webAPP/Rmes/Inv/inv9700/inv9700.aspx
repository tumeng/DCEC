...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="background-color: #99bbbb; width: 100%;">
        <tr>
            ...
            <td style="width: 99px">
                <dx:ASPxComboBox ID="txtPc" runat="server" ValueType="System.String" Width="155px"
    ...
    <table style="background-color: #99bbbb; width: 100%;">
        <tr>
            ...
            <td style="width: 150px">
                <dx:ASPxDateEdit ID="ASPxDateEdit2" runat="server" Width="150px" ClientInstanceName="DateEdit2"
                    EditFormatString="yyyy-MM-dd HH:mm:ss">
                    <CalendarProperties ClearButtonText="清空" TodayButtonText="今天">
                    </CalendarProperties>
                    <ClientSideEvents DateChanged="function(s,e){
            ...
            <td>
                <dx:ASPxButton ID="btnTxt" runat="server" Text="生成文本-TXT" UseSubmitBehavior="False"
                    AutoPostBack="false">
    ...
    <table style="width: 100%; vertical-align: top">
        <tr>
            <td style="width: 90%; vertical-align:top">
                ...
                <ClearFilterButton Visible="True">
                        ...
                        <dx:GridViewDataDateColumn Caption="入出库时间" FieldName="GZRQ" Width="135px" CellStyle-Wrap="False"
        ...
        changeSeq(s,e);
               ...
               if(callbackValue!=null)
                {
                    if(callbackValue.substring(0,5)=='Stock')
                    window.open('http://192.168.112.144/tranlist/storage/'+callbackValue);
                    }
                }" BeginCallback="function(s, e) {
	                grid.cpCallbackValue = '';
                }" />
                </dx:ASPxGridView>
            </td>
            <td style="width: 10%; vertical-align: top">
                <dx:ASPxGridView ID="ASPxGridView2" ClientInstanceName="grid2" runat="server" KeyFieldName="SO"
                    OnCustomCallback="ASPxGridView2_CustomCallback" Width="100%">
                    <%-- <Settings ShowHorizontalScrollBar="false" />--%>
                    <Columns>
                        <dx:GridViewDataTextColumn Caption="SO" FieldName="SO" VisibleIndex="0" Width="100px"
                            Settings-AutoFilterCondition="Contains">
