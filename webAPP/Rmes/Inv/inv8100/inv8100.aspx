    ...
    <table>
        <tr>
            ...
            <td>
                <dx:ASPxComboBox ID="txtPCode" runat="server" DataSourceID="SqlCode" TextField="PLINE_NAME"
                    ValueField="PLINE_CODE" ValueType="System.String" Width="150px" ClientInstanceName="PCode"
                    SelectedIndex="0">
            ...
            <td>
                <dx:ASPxComboBox ID="txtSCode" runat="server" ClientInstanceName="txtSCode1" DataSourceID="StationCode"
                    ...
                    Width="150px" OnCallback="txtSCode_Callback">
                </dx:ASPxComboBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td style="width: 150px">
                <dx:ASPxDateEdit ID="ASPxDateEdit1" runat="server" Width="150px" ClientInstanceName="DateEdit1"
                    ClientVisible="false" EditFormatString="yyyy-MM-dd HH:mm:ss">
                    <CalendarProperties ClearButtonText="清空" TodayButtonText="今天">
                    </CalendarProperties>
                </dx:ASPxDateEdit>
                <dx:ASPxDateEdit ID="ASPxDateEdit3" runat="server" Width="150px" ClientInstanceName="DateEdit3">
                    <CalendarProperties ClearButtonText="清空" TodayButtonText="今天">
                    </CalendarProperties>
                </dx:ASPxDateEdit>
            </td>
            ...
            <td style="width: 150px">
                <dx:ASPxDateEdit ID="ASPxDateEdit2" runat="server" ClientVisible="false" Width="150px"
                    EditFormatString="yyyy-MM-dd HH:mm:ss" ClientInstanceName="DateEdit2">
                    <CalendarProperties ClearButtonText="清空" TodayButtonText="今天">
                    </CalendarProperties>
                </dx:ASPxDateEdit>
                <dx:ASPxComboBox ID="txtBc" runat="server" ValueType="System.String" Width="150px"
        ...
        <tr style="width: 1000px">
            <td>
                <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" AutoGenerateColumns="false"
                    OnCustomCallback="ASPxGridView1_CustomCallback" KeyFieldName="JHDM" Width="650px" OnHtmlRowPrepared="ASPxGridView1_HtmlRowPrepared" >
                    <Columns>
                        <dx:GridViewDataTextColumn Caption="站点名称" FieldName="站点名称" VisibleIndex="1" Width="100px"
                            Settings-AutoFilterCondition="Contains">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="计划代码" FieldName="JHDM" VisibleIndex="2" Width="130px"
                            Settings-AutoFilterCondition="Contains">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="机型" FieldName="PLAN_SO" VisibleIndex="3" Width="100px"
                            Settings-AutoFilterCondition="Contains">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="计划数量" FieldName="计划数量" VisibleIndex="4" Width="80px"
                            Settings-AutoFilterCondition="Contains">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="完成数量" FieldName="完成数量" VisibleIndex="5" Width="80px"
                            Settings-AutoFilterCondition="Contains">
                        </dx:GridViewDataTextColumn>
                    </Columns>
                </dx:ASPxGridView>
                ...
                <fieldset style="text-align: left;">
                    ...
                    <dx:ASPxGridView ID="ASPxGridView2" ClientInstanceName="grid2" runat="server" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="机型" FieldName="PLAN_SO" VisibleIndex="3" Width="120px"
                                Settings-AutoFilterCondition="Contains">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="完成数量" FieldName="完成数量" VisibleIndex="5" Width="80px"
                                Settings-AutoFilterCondition="Contains">
