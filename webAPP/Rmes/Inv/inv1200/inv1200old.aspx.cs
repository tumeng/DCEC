...
namespace Rmes.WebApp.Rmes.Inv.inv1200
{
    public partial class inv1200 : BasePage
    {
        ...
        protected void cmdCfm_Click(object sender, EventArgs e)
        {
            ...
            string m_Sql = "insert into dp_rckwcb(ghtm,so,jhdm,ygmc,rklx,rkdate,gzrq,gzdd,rc,sourceplace,destination,batchId,ch) select ghtm,so,jhdm,ygmc,rklx,rkdate,gzrq,gzdd,rc,sourceplace,destination,batchId,ch from dp_rckwcbtemp where BatchId like'" + v_CurrentBatchId + "' and MachineName='" + GV_MachineName + "' and gzdd='" + GV_Depot + "'";
            dc.ExeSql(m_Sql);
        ...
        protected void CmdPrint_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                rng4 = xSheet.get_Range("H" + sj, Type.Missing);
                ...
                //{
                    ...
                    for (int i = 0; i < lines.Length; i++)
                    {
                        ...
                        if (lines[i].Length > 10)
                        {
                            ...
                            string m_SqlIn = "insert into dp_rckwcbtemp(ghtm,so,jhdm,ygmc,rklx,rkdate,gzrq,gzdd,rc,SourcePlace,destination,BatchId,Ch,MachineName) values('" + m_Ghtm + "','" + m_SO + "','" + m_Jhdm + "','" + m_Ygmc + "','" + m_Lxmc + "','" + m_RkDate + "','" + m_RkDate + "','" + GV_Depot + "','" + m_Rc + "','" + m_SourcePlace + "','" + m_Destination + "','" + m_BatchId + "','" + m_Ch + "','" + GV_MachineName + "')";
                            dc.ExeSql(m_SqlIn);
                        }
                    }
                //}
