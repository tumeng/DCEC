...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <dx:ASPxCallbackPanel runat="server" ID="ASPxCallbackPanel6" ClientInstanceName="ListBoxPanel6">
                            ...
                            <fieldset style="width: 500px; text-align: center; height: 120px">
                                ...
                                <table width="95%">
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxButton ID="CmdPrint" Text="打印收发名单" Width="150px" UseSubmitBehavior="false" AutoPostBack="false" runat="server"   
                                    ...
                                    <tr>
                                        <td>
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <dx:ASPxButton ID="ButRead" Text="读取文本" Width="100px" AutoPostBack="false" UseSubmitBehavior="false"  runat="server"
                                        ...
                                        <td>
                                            <dx:ASPxButton ID="CmdPrint2" Text="打印流水号清单" Width="150px" AutoPostBack="false" UseSubmitBehavior="false"  runat="server" 
                                    ...
                                    <tr>
                                        <td style="text-align:left">
                                            <dx:ASPxComboBox ID="CmbCh" ClientInstanceName="CmbChC" runat="server" Width="320px"  AutoPostBack="false" Visible="false"
                                                Height="25px" DropDownStyle="DropDownList" OnSelectedIndexChanged="CmbCh_SelectedIndexChanged">
                                                <ClientSideEvents SelectedIndexChanged="function(s, e) { grid.PerformCallback('CH|'+CmbChC.GetValue().toString()); }" />
                                            </dx:ASPxComboBox>
                                             <dx:ASPxButton ID="ASPxButton1" runat="server" Text="导出-EXCEL" UseSubmitBehavior="False"
                                                OnClick="btnXlsExport1_Click" />
                                        </td>

                                        <td>
                                            <dx:ASPxButton ID="cmdCfm" Text="出库确认" Width="150px" AutoPostBack="false" runat="server" UseSubmitBehavior="false" 
                            ...
                            <fieldset style="width: 500px; text-align: center; height: 120px;">
                                ...
                                <table width="95%">
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxTextBox  ID="TxtCh" runat="server" ClientInstanceName="TxtCh1" Width="150px" AutoPostBack="false" ><%--OnTextChanged="TxtCh_TextChanged"--%>
                                            <ClientSideEvents KeyDown="function(s,e){if (e.htmlEvent.keyCode == 13){ grid.PerformCallback('CH1|'+TxtCh1.GetValue().toString());} }" />
                                            </dx:ASPxTextBox>
                                        ...
                                        <td>
                                            <dx:ASPxComboBox ID="CmbRklx" ClientInstanceName="CmbRklxC"  runat="server" Width="150px" AutoPostBack="false"
                                                Height="25px" DropDownStyle="DropDownList"  ><%--OnSelectedIndexChanged="CmbRklx_SelectedIndexChanged"--%>
                                                <ClientSideEvents SelectedIndexChanged="function(s, e) { grid.PerformCallback('RK|'+CmbRklxC.GetValue().toString()); }" />
                                            </dx:ASPxComboBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxComboBox ID="CmbFx" ClientInstanceName="CmbFxC"   runat="server" Width="150px" AutoPostBack="false"
                                                Height="25px" DropDownStyle="DropDown"  
                                                ><%--OnSelectedIndexChanged="CmbFx_SelectedIndexChanged"--%>
                                                <ClientSideEvents SelectedIndexChanged="function(s, e) { grid.PerformCallback('FX|'+CmbFxC.GetValue().toString()); }" />
                                            </dx:ASPxComboBox>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <dx:ASPxComboBox ID="CmbYgmc" ClientInstanceName="CmbYgmcC"  runat="server" Width="150px" AutoPostBack="false"
                                                Height="25px" DropDownStyle="DropDownList"  ><%--OnSelectedIndexChanged="CmbYgmc_SelectedIndexChanged"--%>
                                                <ClientSideEvents SelectedIndexChanged="function(s, e) { grid.PerformCallback('YG|'+CmbYgmcC.GetValue().toString()); }" />
                                            </dx:ASPxComboBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                            <table>
                                                <tr>
                                                     <td >
                                                        <dx:ASPxButton ID="batSure" Text="批处理确定" Width="110px" ClientInstanceName="batSureC" UseSubmitBehavior="false" Visible="false" 
                                                            AutoPostBack="false" runat="server" OnClick="batSure_Click"   >
                                                            <%--<ClientSideEvents Click="function(s, e) { filterLsh3(); }" />--%>
                                                        </dx:ASPxButton>
                                                     </td>

                                                    <td style="width: 170px; text-align: right">
                                                        <dx:ASPxButton ID="Cmd_Del1" Text="删除重复扫描" Width="110px" ClientInstanceName="butSubmit" UseSubmitBehavior="false" 
                                                            AutoPostBack="false" runat="server" >
                                                            <ClientSideEvents Click="function(s, e) { filterLsh3(); }" />
                                                        </dx:ASPxButton>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxButton ID="Cmd_Del2" Text="删除重复出库" Width="110px" ClientInstanceName="butSubmit2" UseSubmitBehavior="false" 
                                                            AutoPostBack="false" runat="server" >
                                                            <ClientSideEvents Click="function(s, e) { filterLsh2(); }" />
                                                        </dx:ASPxButton>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxButton ID="cmdQryFj" Text="查看随机附件" Width="110px" AutoPostBack="false" runat="server" UseSubmitBehavior="false" 
                                            ...
                                            <td colspan="6">
                                                <dx:ASPxGridView ID="fpSpDetail" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="员工名称" FieldName="YGMC" Width="70px" VisibleIndex="7" ReadOnly="true">
                                                        </dx:GridViewDataTextColumn>
                                                    ...
                                                    <ClientSideEvents CustomButtonClick="function (s,e){
                                                                    changeSeq(s,e);
                                                                }" EndCallback=" function(s,e){grid21.PerformCallback();}" />
                                                </dx:ASPxGridView>
                                            </td>
                                        </tr>
                                    </table>
                                                        ...
                                                        <td style="text-align: left">
                                                            <dx:ASPxGridView ID="fpSpCal" ClientInstanceName="grid21" runat="server" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="STR1" Width="150px" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="方向" FieldName="DESTINATION" Width="200px">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="STR2" Width="150px" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="STR3" Width="150px" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="STR4" Width="150px" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="SO" FieldName="SO" Width="200px">
                                                                    </dx:GridViewDataTextColumn>
                                                                    <dx:GridViewDataTextColumn Caption="" FieldName="STR5" Width="150px" Visible="false">
                                                                    </dx:GridViewDataTextColumn>
                                                ...
                                                <table width="100%">
                                                    <tr>
                                                        ...
                                                        <td style="width: 190px">
                                                            <dx:ASPxButton ID="cmdSelSj" Text="查看所选时间随机附件" AutoPostBack="false" runat="server" UseSubmitBehavior="false" 
                                                        ...
                                                        <td style="width: 160px">
                                                            ...
                                                            <dx:ASPxButton ID="btnXlsExport" runat="server" Text="打印随机附件"  UseSubmitBehavior="false" 
                                                                OnClick="btnXlsExport_Click" />
                                                        </td>
                                                        <td style="width: 110px">
                                                            <dx:ASPxButton ID="cmdShut" Text="退出" AutoPostBack="false" runat="server" Width="100px" UseSubmitBehavior="false" 
        ...
        <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server" GridViewID="fpSpDetail">
</dx:ASPxGridViewExporter>
