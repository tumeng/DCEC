<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="inv1200bak.aspx.cs" Inherits="Rmes.WebApp.Rmes.Inv.inv1200.inv1200" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxButton ID="CmdPrint" Text="打印收发名单" Width="150px" AutoPostBack="false" runat="server"  
                                                OnClick="CmdPrint_Click" UseSubmitBehavior="false">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxComboBox ID="CmbFx" ClientInstanceName="CmbFxC" runat="server" Width="150px"
                                                Height="25px"  AutoPostBack="true" DropDownStyle="DropDown">
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <table>
                                                <tr>
                                                    <td >
                                                        <dx:ASPxButton ID="batSure" Text="批处理确定" Width="110px" ClientInstanceName="batSureC"
                                                            AutoPostBack="false" runat="server" OnClick="batSure_Click"   >
                                                            <%--<ClientSideEvents Click="function(s, e) { filterLsh3(); }" />--%>
                                                        </dx:ASPxButton>
                                                    </td>
                                                    <td >
                                                        <dx:ASPxButton ID="Cmd_Del1" Text="删除重复扫描" Width="110px" ClientInstanceName="butSubmit"
                                                            AutoPostBack="false" runat="server" >
                                                            <ClientSideEvents Click="function(s, e) { filterLsh3(); }" />
                                                        </dx:ASPxButton>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxButton ID="Cmd_Del2" Text="删除重复出库" Width="110px" ClientInstanceName="butSubmit2"
                                                            AutoPostBack="false" runat="server" >
                                                            <ClientSideEvents Click="function(s, e) { filterLsh2(); }" />
                                                        </dx:ASPxButton>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxButton ID="cmdQryFj" Text="查看随机附件" Width="110px" AutoPostBack="false" runat="server"
