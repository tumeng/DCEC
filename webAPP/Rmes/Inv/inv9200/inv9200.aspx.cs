...
public partial class Rmes_inv9200 : Rmes.Web.Base.BasePage
{
    ...
    private void setCondition()
    {
       ...
       {
           sql = sql + " AND to_char(RQSJ1,'YYYY-MM-DD')>=to_char(to_date('"+ASPxDateEdit1.Text.Trim()+"', 'YYYY-MM-DD  hh24:mi:ss'),'YYYY-MM-DD') ";
       }
       if (ASPxDateEdit3.Text.Trim() != "")
       {
           sql = sql + " AND to_char(RQSJ1,'YYYY-MM-DD')<=to_char(to_date('"+ASPxDateEdit3.Text.Trim()+"', 'YYYY-MM-DD  hh24:mi:ss'),'YYYY-MM-DD') ";
       }
