                            ...
                            <fieldset style="width: 460px; text-align: center; height: 140px">
                                ...
                                <table width="95%">
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxComboBox ID="comboPline" ClientInstanceName="cPlineC" runat="server" Width="110px" SelectedIndex="0"
                                                Height="25px" DropDownStyle="DropDownList" ValueField="PLINE_CODE" TextField="PLINE_NAME" AutoPostBack="true">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxComboBox ID="comboBatch" ClientInstanceName="comboBatchC" runat="server" AutoPostBack="true"
