        ...
        <tr>
            ...
            <td>
                <dx:ASPxComboBox ID="txtPCode" runat="server" DataSourceID="SqlCode" TextField="PLINE_NAME"
                    ValueField="PLINE_CODE" ValueType="System.String" Width="120px" ClientInstanceName="PCode" SelectedIndex="0">
                </dx:ASPxComboBox>
            </td>
            <td style="width: 25px">
            ...
            <td style="width: 99px">
                <dx:ASPxComboBox ID="txtPc" runat="server" ValueType="System.String" Width="140px" ClientInstanceName="Batch">
