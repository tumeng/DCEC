...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        function initEditSeries(s, e) {
            ...
            + "&LOCATION=" + Location1.GetValue() + " &PROCESS=" + Process1.GetValue() + " &opFlag=getEditSeries";
            var result = "";
                ...
                <table style="background-color: #99bbbb; width: 100%;">
                    ...
                    <tr>
                        ...
                        <td style="width: 100px;">
                            <dx:ASPxComboBox ID="ComboItem" ClientInstanceName="Item1" runat="server"  ValueType="System.String" Width="100px"  SelectedIndex="0"  
                                DataSourceID="sqlItem" ValueField="COMP" TextField="COMP"  OnCallback="ComboItem_Callback"   DropDownStyle="DropDownList"> 
                        ...
                        <td style="width: 100px;">
                            <dx:ASPxComboBox ID="ComboLocation" ClientInstanceName="Location1"  ValueType="System.String" runat="server" SelectedIndex="0"
                                Width="100px" DataSourceID="sqlItem2"  ValueField="GWMC" TextField="GWMC" OnCallback="ComboLocation_Callback"  DropDownStyle="DropDownList">
                            <ClientSideEvents  SelectedIndexChanged ="function(s, e) { filter() }" />
                            </dx:ASPxComboBox>
                        </td>
                        <td style="width: 85px; text-align: left;">
                        ...
                        <td style="width: 100px;">
                            <dx:ASPxComboBox ID="ComboProcess" ClientInstanceName="Process1"  ValueType="System.String" runat="server" Width="100px" SelectedIndex="0"
                                DataSourceID="sqlItem3"  ValueField="GXMC" TextField="GXMC" OnCallback="ComboProcess_Callback"  DropDownStyle="DropDownList">
                            </dx:ASPxComboBox>
                        </td>
                        <td style="width: 70px;">
                            <dx:ASPxLabel ID="ASPxLabel11" runat="server" Text="数量(原零件)" Visible="false">
                            </dx:ASPxLabel>
                        </td>
                        <td style="width: 100px;">
                            <dx:ASPxTextBox ID="txtSL" ClientInstanceName="SL1" runat="server" Width="100px" Visible="false">
