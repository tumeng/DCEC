    ...
    public class PubJs
    {
        ...
        public  void JscriptSender(System.Web.UI.Page page)
        {
           ...
           <script language=Javascript>
            ...
            page.ClientScript.RegisterStartupScript(this.GetType(),"sds",s);
        }
        /// <summary>
        /// 弹出JavaScript小窗口
        /// </summary>
        ...
        public  void RtnRltMsgbox(object message,string strWinCtrl)
        {   
            string js = @"<Script language='JavaScript'>
                     strWinCtrl = true;
        ...
        public  void OpenWebForm(string url)
        {
            /*…………………………………………………………………………………………*/
            /*修改目的:    新开页面去掉ie的菜单。。。                        */
        ...
        public  void OpenWebForm(string url,string name,string future)
        {
            string js=@"<Script language='JavaScript'>
        ...
        public  void OpenWebForm(string url,bool isFullScreen)
        {            
            string js=@"<Script language='JavaScript'>";
            if(isFullScreen)
            {
        ...
        /// <param name="url"></param>
        public  void JavaScriptFrameHref(string FrameName,string url)
        {
            string js=@"<Script language='JavaScript'>
        ...
        ///重置页面
        /// </summary>
        public  void JavaScriptResetPage(string strRows)
        {
            string js=@"<Script language='JavaScript'>
        ...
        public  void JavaScriptSetCookie(string strName,string strValue)
        {
            string js=@"<script language=Javascript>
        ...
        public  void ReplaceParentWindow(string parentWindowUrl,string caption,string future)
        {    
            string js="";
        ...
        public  void ReplaceOpenerParentFrame(string frameName,string frameWindowUrl)
        {            
            string js=@"<Script language='JavaScript'>
        ...
        /// <returns></returns>
        public  string ShowModalDialogJavascript(string webFormUrl)
        {
            string js=@"<script language=javascript>
                            var iWidth = 0 ;
                            var iHeight = 0 ;
        ...
        /// <param name="webFormUrl"></param>
        /// <returns></returns>
        public  void ShowModalDialogWindow(string webFormUrl)
        {
        ...
        public  void SetHtmlElementValue(string formName,string elementName,string elementValue)
        {            
        ...
        //判断字段超长
        public int islength(string a)
        {
            byte[] tmp = (System.Text.UnicodeEncoding.Default.GetBytes(a));
            return tmp.Length;
        }
