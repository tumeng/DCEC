...
{
    public partial class frmPrintQual : Rmes.WinForm.Base.BaseForm
    {
        public frmPrintQual(Form owner)
        {
            InitializeComponent();
            this.FormClosed += new FormClosedEventHandler(frmPrintQual_FormClosed);
            ...
            basicInfo.Top = 0;
            basicInfo.Left = 0;
            ctrlPrintQual print = new ctrlPrintQual();
        ...
        void frmPrintQual_FormClosed(object sender, FormClosedEventArgs e)
        {
